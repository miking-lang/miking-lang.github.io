...
<a href={"/docs/Stdlib/map.mc"} style={S.link}>map.mc</a>, <a href={"/docs/Stdlib/set.mc"} style={S.link}>set.mc</a>, <a href={"/docs/Stdlib/log.mc"} style={S.link}>log.mc</a>, <a href={"/docs/Stdlib/utest.mc"} style={S.link}>utest.mc</a>, <a href={"/docs/Stdlib/mexpr/ast.mc"} style={S.link}>mexpr/ast.mc</a>, <a href={"/docs/Stdlib/mexpr/ast-builder.mc"} style={S.link}>mexpr/ast-builder.mc</a>, <a href={"/docs/Stdlib/mexpr/eval.mc"} style={S.link}>mexpr/eval.mc</a>, <a href={"/docs/Stdlib/mexpr/pprint.mc"} style={S.link}>mexpr/pprint.mc</a>, <a href={"/docs/Stdlib/mexpr/boot-parser.mc"} style={S.link}>mexpr/boot-parser.mc</a>, <a href={"/docs/Stdlib/mexpr/side-effect.mc"} style={S.link}>mexpr/side-effect.mc</a>  
  
## Types  
  

          <DocBlock title="PEvalLetInlineOrRemove" kind="type">
...
## Constructors  
          ...
          <DocBlock title="PEvalLetInline" kind="con">
...
```
          ...
          <DocBlock title="PEvalLetRemove" kind="con">
...
## Languages  
          ...
          <DocBlock title="PEvalCtx" kind="lang" link="/docs/Stdlib/peval/peval.mc/lang-PEvalCtx/type-PEvalCtx">
...
```
          ...
          <DocBlock title="PEval" kind="lang" link="/docs/Stdlib/peval/peval.mc/lang-PEval">
...
```
          ...
          <DocBlock title="PEvalApply" kind="lang" link="/docs/Stdlib/peval/peval.mc/lang-PEvalApply">
...
```
          ...
          <DocBlock title="AppPEval" kind="lang" link="/docs/Stdlib/peval/peval.mc/lang-AppPEval">
...
```
          ...
          <DocBlock title="VarPEval" kind="lang" link="/docs/Stdlib/peval/peval.mc/lang-VarPEval">
...
```
          ...
          <DocBlock title="ClosPAst" kind="lang" link="/docs/Stdlib/peval/peval.mc/lang-ClosPAst">
...
```
          ...
          <DocBlock title="LamPEval" kind="lang" link="/docs/Stdlib/peval/peval.mc/lang-LamPEval">
...
```
          ...
          <DocBlock title="LetPEval" kind="lang" link="/docs/Stdlib/peval/peval.mc/lang-LetPEval">
...
```
          ...
          <DocBlock title="RecLetsPEval" kind="lang" link="/docs/Stdlib/peval/peval.mc/lang-RecLetsPEval">
...
```
          ...
          <DocBlock title="RecordPEval" kind="lang" link="/docs/Stdlib/peval/peval.mc/lang-RecordPEval">
...
```
          ...
          <DocBlock title="TypePEval" kind="lang" link="/docs/Stdlib/peval/peval.mc/lang-TypePEval">
...
```
          ...
          <DocBlock title="DataPEval" kind="lang" link="/docs/Stdlib/peval/peval.mc/lang-DataPEval">
...
```
          ...
          <DocBlock title="SeqPEval" kind="lang" link="/docs/Stdlib/peval/peval.mc/lang-SeqPEval">
...
```
          ...
          <DocBlock title="ConstPEval" kind="lang" link="/docs/Stdlib/peval/peval.mc/lang-ConstPEval">
...
```
          ...
          <DocBlock title="MatchPEval" kind="lang" link="/docs/Stdlib/peval/peval.mc/lang-MatchPEval">
...
```
          ...
          <DocBlock title="UtestPEval" kind="lang" link="/docs/Stdlib/peval/peval.mc/lang-UtestPEval">
...
```
          ...
          <DocBlock title="NeverPEval" kind="lang" link="/docs/Stdlib/peval/peval.mc/lang-NeverPEval">
...
```
          ...
          <DocBlock title="ExtPEval" kind="lang" link="/docs/Stdlib/peval/peval.mc/lang-ExtPEval">
...
```
          ...
          <DocBlock title="ArithIntPEval" kind="lang" link="/docs/Stdlib/peval/peval.mc/lang-ArithIntPEval">
...
```
          ...
          <DocBlock title="ArithFloatPEval" kind="lang" link="/docs/Stdlib/peval/peval.mc/lang-ArithFloatPEval">

```mc
lang ArithFloatPEval
```
...
```
          ...
          <DocBlock title="CmpFloatPEval" kind="lang" link="/docs/Stdlib/peval/peval.mc/lang-CmpFloatPEval">
...
```
          ...
          <DocBlock title="CmpIntPEval" kind="lang" link="/docs/Stdlib/peval/peval.mc/lang-CmpIntPEval">
...
```
          ...
          <DocBlock title="CmpCharPEval" kind="lang" link="/docs/Stdlib/peval/peval.mc/lang-CmpCharPEval">
...
```
          ...
          <DocBlock title="IOPEval" kind="lang" link="/docs/Stdlib/peval/peval.mc/lang-IOPEval">
...
```
          ...
          <DocBlock title="SeqOpPEval" kind="lang" link="/docs/Stdlib/peval/peval.mc/lang-SeqOpPEval">
...
```
          ...
          <DocBlock title="PEvalLetInline" kind="lang" link="/docs/Stdlib/peval/peval.mc/lang-PEvalLetInline">
...
```
          ...
          <DocBlock title="MExprPEval" kind="lang" link="/docs/Stdlib/peval/peval.mc/lang-MExprPEval">
...
```
          ...
          <DocBlock title="TestLang" kind="lang" link="/docs/Stdlib/peval/peval.mc/lang-TestLang">
...
## Variables  
          ...
          <DocBlock title="astBuilder" kind="let">

```mc
let astBuilder info : Info -> {app: Ast_Expr -> Ast_Expr -> Ast_Expr, int: Int -> Ast_Expr, seq: [Ast_Expr] -> Ast_Expr, var: Name -> Ast_Expr, app2: Ast_Expr -> Ast_Expr -> Ast_Expr -> Ast_Expr, mulf: Ast_Expr -> Ast_Expr -> Ast_Expr, muli: Ast_Expr -> Ast_Expr -> Ast_Expr, negf: Ast_Expr -> Ast_Expr, negi: Ast_Expr -> Ast_Expr, float: Float -> Ast_Expr, nulam: Name -> Ast_Expr -> Ast_Expr, nulet: Name -> Ast_Expr -> Ast_Decl, appSeq: Ast_Expr -> [Ast_Expr] -> Ast_Expr, uconst: ConstAst_Const -> Ast_Expr}
```
