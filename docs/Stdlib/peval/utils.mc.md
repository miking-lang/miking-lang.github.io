...
<a href={"/docs/Stdlib/peval/include.mc"} style={S.link}>peval/include.mc</a>, <a href={"/docs/Stdlib/peval/ast.mc"} style={S.link}>peval/ast.mc</a>, <a href={"/docs/Stdlib/mexpr/utils.mc"} style={S.link}>mexpr/utils.mc</a>, <a href={"/docs/Stdlib/mexpr/ast.mc"} style={S.link}>mexpr/ast.mc</a>, <a href={"/docs/Stdlib/set.mc"} style={S.link}>set.mc</a>  
  
## Languages  
  

          <DocBlock title="SpecializeUtils" kind="lang" link="/docs/Stdlib/peval/utils.mc/lang-SpecializeUtils">

```mc
lang SpecializeUtils
```
