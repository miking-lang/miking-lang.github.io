...
## Variables  
          ...
          <DocBlock title="implWithLibs" kind="let">

```mc
let implWithLibs arg : all a. {ty: Ast_Type, expr: String, libraries: [String]} -> {ty: Ast_Type, expr: String, libraries: [String], cLibraries: [a]}
```
...
```
          ...
          <DocBlock title="myrecty1" kind="let">

```mc
let myrecty1  : Ast_Type
```
...
```
          ...
          <DocBlock title="myrecty2" kind="let">

```mc
let myrecty2  : Ast_Type
```
...
```
          ...
          <DocBlock title="myrecty3" kind="let">

```mc
let myrecty3  : Ast_Type
```
...
```
          ...
          <DocBlock title="extTestMap" kind="let">

```mc
let extTestMap  : Map String [{ty: Ast_Type, expr: String, libraries: [String], cLibraries: [String]}]
```
