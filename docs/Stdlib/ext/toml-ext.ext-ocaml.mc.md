...
## Variables  
          ...
          <DocBlock title="tyTomlTable_" kind="let">

```mc
let tyTomlTable_  : Ast_Type
```
...
```
          ...
          <DocBlock title="tyTomlValue_" kind="let">

```mc
let tyTomlValue_  : Ast_Type
```
...
```
          ...
          <DocBlock title="tomlExtMap" kind="let">

```mc
let tomlExtMap  : Map String [{ty: Ast_Type, expr: String, libraries: [String], cLibraries: [String]}]
```
