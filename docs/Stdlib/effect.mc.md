...
<a href={"/docs/Stdlib/option.mc"} style={S.link}>option.mc</a>, <a href={"/docs/Stdlib/either.mc"} style={S.link}>either.mc</a>  
  
## Languages  
  

          <DocBlock title="Effect" kind="lang" link="/docs/Stdlib/effect.mc/lang-Effect">
...
```
          ...
          <DocBlock title="Reader" kind="lang" link="/docs/Stdlib/effect.mc/lang-Reader">
...
```
          ...
          <DocBlock title="Writer" kind="lang" link="/docs/Stdlib/effect.mc/lang-Writer">
...
```
          ...
          <DocBlock title="State" kind="lang" link="/docs/Stdlib/effect.mc/lang-State/syn-State">
...
```
          ...
          <DocBlock title="NonDet" kind="lang" link="/docs/Stdlib/effect.mc/lang-NonDet">
...
```
          ...
          <DocBlock title="Failure" kind="lang" link="/docs/Stdlib/effect.mc/lang-Failure/syn-Failure">
...
```
          ...
          <DocBlock title="TestLang" kind="lang" link="/docs/Stdlib/effect.mc/lang-TestLang">
...
```
          ...
          <DocBlock title="TestLangImpl" kind="lang" link="/docs/Stdlib/effect.mc/lang-TestLangImpl">
