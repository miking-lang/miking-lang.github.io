...
<a href={"/docs/Stdlib/mexpr/boot-parser.mc"} style={S.link}>mexpr/boot-parser.mc</a>, <a href={"/docs/Stdlib/mexpr/symbolize.mc"} style={S.link}>mexpr/symbolize.mc</a>, <a href={"/docs/Stdlib/mexpr/pprint.mc"} style={S.link}>mexpr/pprint.mc</a>, <a href={"/docs/Stdlib/mexpr/info.mc"} style={S.link}>mexpr/info.mc</a>, <a href={"/docs/Stdlib/mexpr/ast.mc"} style={S.link}>mexpr/ast.mc</a>, <a href={"/docs/Stdlib/javascript/ast.mc"} style={S.link}>javascript/ast.mc</a>, <a href={"/docs/Stdlib/javascript/util.mc"} style={S.link}>javascript/util.mc</a>, <a href={"/docs/Stdlib/javascript/pprint.mc"} style={S.link}>javascript/pprint.mc</a>, <a href={"/docs/Stdlib/javascript/patterns.mc"} style={S.link}>javascript/patterns.mc</a>, <a href={"/docs/Stdlib/javascript/intrinsics.mc"} style={S.link}>javascript/intrinsics.mc</a>, <a href={"/docs/Stdlib/javascript/optimizations.mc"} style={S.link}>javascript/optimizations.mc</a>, <a href={"/docs/Stdlib/sys.mc"} style={S.link}>sys.mc</a>, <a href={"/docs/Stdlib/common.mc"} style={S.link}>common.mc</a>, <a href={"/docs/Stdlib/seq.mc"} style={S.link}>seq.mc</a>, <a href={"/docs/Stdlib/set.mc"} style={S.link}>set.mc</a>, <a href={"/docs/Stdlib/error.mc"} style={S.link}>error.mc</a>, <a href={"/docs/Stdlib/name.mc"} style={S.link}>name.mc</a>, <a href={"/docs/Stdlib/option.mc"} style={S.link}>option.mc</a>, <a href={"/docs/Stdlib/string.mc"} style={S.link}>string.mc</a>, <a href={"/docs/Stdlib/bool.mc"} style={S.link}>bool.mc</a>  
  
## Languages  
  

          <DocBlock title="MExprJSCompile" kind="lang" link="/docs/Stdlib/javascript/compile.mc/lang-MExprJSCompile">
...
## Variables  
          ...
          <DocBlock title="_lastSubStr" kind="let">

```mc
let _lastSubStr str n : String -> Int -> Option String
```
...
```
          ...
          <DocBlock title="isInModule" kind="let">

```mc
let isInModule ctx modulePath : CompileJSContext -> String -> Bool
```
...
```
          ...
          <DocBlock title="isInFunc" kind="let">

```mc
let isInFunc ctx funcName : CompileJSContext -> String -> Bool
```
...
```
          ...
          <DocBlock title="isInModuleFunc" kind="let">

```mc
let isInModuleFunc ctx funcName modulePath : CompileJSContext -> String -> String -> Bool
```
...
```
          ...
          <DocBlock title="isInModuleFuncs" kind="let">

```mc
let isInModuleFuncs ctx funModules info onSuccess onError : all a. CompileJSContext -> [(String, String)] -> Info -> (() -> a) -> (() -> a) -> a
```
...
```
          ...
          <DocBlock title="infoWarn" kind="let">

```mc
let infoWarn info msg : Info -> String -> ()
```
...
```
          ...
          <DocBlock title="filepathWithoutExtension" kind="let">

```mc
let filepathWithoutExtension filename : String -> String
```

<Description>{`Helper functions`}</Description>
...
```
          ...
          <DocBlock title="javascriptCompile" kind="let">

```mc
let javascriptCompile opts ast : CompileJSOptions -> Ast_Expr -> JSProgAst_JSProg
```

<Description>{`Compile a Miking AST to a JavaScript program AST.  
Walk the AST and convert it to a JavaScript AST.`}</Description>
...
```
          ...
          <DocBlock title="javascriptCompileFile" kind="let">

```mc
let javascriptCompileFile opts ast sourcePath : CompileJSOptions -> Ast_Expr -> String -> String
```
