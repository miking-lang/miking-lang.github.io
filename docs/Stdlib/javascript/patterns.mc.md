...
<a href={"/docs/Stdlib/bool.mc"} style={S.link}>bool.mc</a>, <a href={"/docs/Stdlib/seq.mc"} style={S.link}>seq.mc</a>, <a href={"/docs/Stdlib/error.mc"} style={S.link}>error.mc</a>, <a href={"/docs/Stdlib/common.mc"} style={S.link}>common.mc</a>, <a href={"/docs/Stdlib/stringid.mc"} style={S.link}>stringid.mc</a>, <a href={"/docs/Stdlib/mexpr/ast.mc"} style={S.link}>mexpr/ast.mc</a>, <a href={"/docs/Stdlib/javascript/ast.mc"} style={S.link}>javascript/ast.mc</a>, <a href={"/docs/Stdlib/javascript/util.mc"} style={S.link}>javascript/util.mc</a>  
  
## Languages  
  

          <DocBlock title="PatJSCompile" kind="lang" link="/docs/Stdlib/javascript/patterns.mc/lang-PatJSCompile">
