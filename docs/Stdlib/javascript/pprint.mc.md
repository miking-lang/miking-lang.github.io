...
<a href={"/docs/Stdlib/javascript/ast.mc"} style={S.link}>javascript/ast.mc</a>, <a href={"/docs/Stdlib/string.mc"} style={S.link}>string.mc</a>, <a href={"/docs/Stdlib/char.mc"} style={S.link}>char.mc</a>, <a href={"/docs/Stdlib/mexpr/pprint.mc"} style={S.link}>mexpr/pprint.mc</a>  
  
## Languages  
  

          <DocBlock title="JSPrettyPrint" kind="lang" link="/docs/Stdlib/javascript/pprint.mc/lang-JSPrettyPrint">
...
```
          ...
          <DocBlock title="JSProgPrettyPrint" kind="lang" link="/docs/Stdlib/javascript/pprint.mc/lang-JSProgPrettyPrint">

```mc
lang JSProgPrettyPrint
```
...
## Variables  
          ...
          <DocBlock title="pprintEnvGetStr" kind="let">

```mc
let pprintEnvGetStr env id : PprintEnv -> Name -> (PprintEnv, String)
```
...
```
          ...
          <DocBlock title="joinAsStatements" kind="let">

```mc
let joinAsStatements indent seq : Int -> [String] -> String
```
...
```
          ...
          <DocBlock title="getNameStrDefault" kind="let">

```mc
let getNameStrDefault default env id : String -> PprintEnv -> Name -> (PprintEnv, String)
```
...
```
          ...
          <DocBlock title="jsKeywords" kind="let">

```mc
let jsKeywords  : [String]
```

<Description>{`From Draft ECMA\-262 / March 3, 2022 \(https://tc39.es/ecma262/\#sec\-keywords\-and\-reserved\-words\)`}</Description>
