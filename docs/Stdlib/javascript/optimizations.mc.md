...
<a href={"/docs/Stdlib/javascript/ast.mc"} style={S.link}>javascript/ast.mc</a>, <a href={"/docs/Stdlib/javascript/util.mc"} style={S.link}>javascript/util.mc</a>, <a href={"/docs/Stdlib/javascript/intrinsics.mc"} style={S.link}>javascript/intrinsics.mc</a>, <a href={"/docs/Stdlib/name.mc"} style={S.link}>name.mc</a>, <a href={"/docs/Stdlib/bool.mc"} style={S.link}>bool.mc</a>, <a href={"/docs/Stdlib/set.mc"} style={S.link}>set.mc</a>  
  
## Types  
  

          <DocBlock title="JSTCOContext" kind="type">

```mc
type JSTCOContext : { expr: JSExpr, foundTailCall: Bool }
```
...
## Languages  
          ...
          <DocBlock title="JSOptimizeBlocks" kind="lang" link="/docs/Stdlib/javascript/optimizations.mc/lang-JSOptimizeBlocks">

```mc
lang JSOptimizeBlocks
```

<Description>{`Block Optimizations`}</Description>
...
```
          ...
          <DocBlock title="JSOptimizeTailCalls" kind="lang" link="/docs/Stdlib/javascript/optimizations.mc/lang-JSOptimizeTailCalls">

```mc
lang JSOptimizeTailCalls
```

<Description>{`Tail Call Optimizations`}</Description>
...
```
          ...
          <DocBlock title="JSOptimizeExprs" kind="lang" link="/docs/Stdlib/javascript/optimizations.mc/lang-JSOptimizeExprs">

```mc
lang JSOptimizeExprs
```
