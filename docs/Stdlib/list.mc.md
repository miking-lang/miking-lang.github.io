...
## Variables  
          ...
          <DocBlock title="listEmpty" kind="let">

```mc
let listEmpty  : all a. List a
```
...
```
          ...
          <DocBlock title="listNil" kind="let">

```mc
let listNil li : all a. List a -> Bool
```
...
```
          ...
          <DocBlock title="listCons" kind="let">

```mc
let listCons e li : all a. a -> List a -> List a
```
...
```
          ...
          <DocBlock title="listFind" kind="let">

```mc
let listFind p li : all a. (a -> Bool) -> List a -> Option a
```
...
```
          ...
          <DocBlock title="listFindMap" kind="let">

```mc
let listFindMap p li : all a. all b. (a -> Option b) -> List a -> Option b
```
...
```
          ...
          <DocBlock title="listFindMapWithIndex" kind="let">

```mc
let listFindMapWithIndex p li : all a. all b. (Int -> a -> Option b) -> List a -> Option b
```
...
```
          ...
          <DocBlock title="listFromSeq" kind="let">

```mc
let listFromSeq l : all a. [a] -> List a
```
...
```
          ...
          <DocBlock title="listFoldl" kind="let">

```mc
let listFoldl f : all a. all b. (b -> a -> b) -> b -> List a -> b
```
...
```
          ...
          <DocBlock title="listReverse" kind="let">

```mc
let listReverse l : all a. List a -> List a
```
...
```
          ...
          <DocBlock title="listMap" kind="let">

```mc
let listMap f li : all a. all b. (a -> b) -> List a -> List b
```
...
```
          ...
          <DocBlock title="listToSeq" kind="let">

```mc
let listToSeq l : all a. List a -> [a]
```
...
```
          ...
          <DocBlock title="listEq" kind="let">

```mc
let listEq eqElem : all a. all b. (a -> b -> Bool) -> List a -> List b -> Bool
```
...
```
          ...
          <DocBlock title="listAll" kind="let">

```mc
let listAll p li : all a. (a -> Bool) -> List a -> Bool
```
...
```
          ...
          <DocBlock title="listFilter" kind="let">

```mc
let listFilter p li : all a. (a -> Bool) -> List a -> List a
```
...
```
          ...
          <DocBlock title="listConcat" kind="let">

```mc
let listConcat lhs rhs : all a. List a -> List a -> List a
```
