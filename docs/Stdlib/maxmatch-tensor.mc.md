...
<a href={"/docs/Stdlib/math.mc"} style={S.link}>math.mc</a>, <a href={"/docs/Stdlib/tensor.mc"} style={S.link}>tensor.mc</a>, <a href={"/docs/Stdlib/common.mc"} style={S.link}>common.mc</a>  
...
## Variables  
          ...
          <DocBlock title="slackToString" kind="let">

```mc
let slackToString slack : Slack -> String
```
...
```mc
let maxmatchHungarian w : Tensor[Int] -> {weight: Int, incidenceU: Tensor[Int], incidenceV: Tensor[Int]}
```
...
```mc
let maxmatchFindMatch w : Tensor[Int] -> {weight: Int, incidenceU: Tensor[Int], incidenceV: Tensor[Int]}
```
