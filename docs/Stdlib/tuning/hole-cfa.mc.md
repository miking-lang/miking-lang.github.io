...
1. In a match, if the \_condition is data\-dependent\_ on hole \`h\`, then the  
   \_execution time\_ of the match is dependent on \`h\`.  
...
<a href={"/docs/Stdlib/mexpr/cfa.mc"} style={S.link}>mexpr/cfa.mc</a>, <a href={"/docs/Stdlib/mexpr/const-arity.mc"} style={S.link}>mexpr/const-arity.mc</a>, <a href={"/docs/Stdlib/mexpr/symbolize.mc"} style={S.link}>mexpr/symbolize.mc</a>, <a href={"/docs/Stdlib/mexpr/cmp.mc"} style={S.link}>mexpr/cmp.mc</a>, <a href={"/docs/Stdlib/name.mc"} style={S.link}>name.mc</a>, <a href={"/docs/Stdlib/common.mc"} style={S.link}>common.mc</a>, <a href={"/docs/Stdlib/tensor.mc"} style={S.link}>tensor.mc</a>, <a href={"/docs/Stdlib/tuning/ast.mc"} style={S.link}>ast.mc</a>, <a href={"/docs/Stdlib/tuning/const-dep.mc"} style={S.link}>const-dep.mc</a>, <a href={"/docs/Stdlib/tuning/context-expansion.mc"} style={S.link}>context-expansion.mc</a>  
  
## Languages  
  

          <DocBlock title="MExprHoleCFA" kind="lang" link="/docs/Stdlib/tuning/hole-cfa.mc/lang-MExprHoleCFA">
...
```
          ...
          <DocBlock title="Test" kind="lang" link="/docs/Stdlib/tuning/hole-cfa.mc/lang-Test">
...
```
          ...
          <DocBlock title="MExpr" kind="lang" link="/docs/Stdlib/tuning/hole-cfa.mc/lang-MExpr">
