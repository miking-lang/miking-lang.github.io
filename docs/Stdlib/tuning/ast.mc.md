...
<a href={"/docs/Stdlib/mexpr/ast.mc"} style={S.link}>mexpr/ast.mc</a>, <a href={"/docs/Stdlib/mexpr/anf.mc"} style={S.link}>mexpr/anf.mc</a>, <a href={"/docs/Stdlib/mexpr/keyword-maker.mc"} style={S.link}>mexpr/keyword-maker.mc</a>, <a href={"/docs/Stdlib/mexpr/boot-parser.mc"} style={S.link}>mexpr/boot-parser.mc</a>, <a href={"/docs/Stdlib/mexpr/type-check.mc"} style={S.link}>mexpr/type-check.mc</a>  
  
## Languages  
  

          <DocBlock title="HoleAstBase" kind="lang" link="/docs/Stdlib/tuning/ast.mc/lang-HoleAstBase">
...
```
          ...
          <DocBlock title="HoleBoolAst" kind="lang" link="/docs/Stdlib/tuning/ast.mc/lang-HoleBoolAst">

```mc
lang HoleBoolAst
```

<Description>{`A Boolean hole.`}</Description>
...
```
          ...
          <DocBlock title="HoleIntRangeAst" kind="lang" link="/docs/Stdlib/tuning/ast.mc/lang-HoleIntRangeAst">

```mc
lang HoleIntRangeAst
```

<Description>{`An integer hole \(range of integers\).`}</Description>
...
```
          ...
          <DocBlock title="HoleAnnotation" kind="lang" link="/docs/Stdlib/tuning/ast.mc/lang-HoleAnnotation">
...
```
          ...
          <DocBlock title="IndependentAst" kind="lang" link="/docs/Stdlib/tuning/ast.mc/lang-IndependentAst">

```mc
lang IndependentAst
```

<Description>{`Independency annotation`}</Description>
...
```
          ...
          <DocBlock title="HoleAst" kind="lang" link="/docs/Stdlib/tuning/ast.mc/lang-HoleAst">
...
```
          ...
          <DocBlock title="HoleANF" kind="lang" link="/docs/Stdlib/tuning/ast.mc/lang-HoleANF">
...
```
          ...
          <DocBlock title="HoleANFAll" kind="lang" link="/docs/Stdlib/tuning/ast.mc/lang-HoleANFAll">
...
```
          ...
          <DocBlock title="Test" kind="lang" link="/docs/Stdlib/tuning/ast.mc/lang-Test">
...
## Variables  
          ...
          <DocBlock title="_lookupExit" kind="let">

```mc
let _lookupExit info s m : all a. Info -> String -> Map String a -> a
```
...
```
          ...
          <DocBlock title="_expectConstInt" kind="let">

```mc
let _expectConstInt info s i : Info -> String -> Ast_Expr -> Int
```
...
```
          ...
          <DocBlock title="holeBool_" kind="let">

```mc
let holeBool_ default depth : Bool -> Int -> Ast_Expr
```
...
```
          ...
          <DocBlock title="holeIntRange_" kind="let">

```mc
let holeIntRange_ default depth min max : Int -> Int -> Int -> Int -> Ast_Expr
```
