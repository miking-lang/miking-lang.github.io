...
<a href={"/docs/Stdlib/tuning/hole-cfa.mc"} style={S.link}>hole-cfa.mc</a>, <a href={"/docs/Stdlib/tuning/prefix-tree.mc"} style={S.link}>prefix-tree.mc</a>, <a href={"/docs/Stdlib/tuning/nested.mc"} style={S.link}>nested.mc</a>, <a href={"/docs/Stdlib/graph.mc"} style={S.link}>graph.mc</a>, <a href={"/docs/Stdlib/set.mc"} style={S.link}>set.mc</a>, <a href={"/docs/Stdlib/name.mc"} style={S.link}>name.mc</a>  
...
```mc
type DependencyGraph : { graph: Graph Int Int, measuringPoints: Map Name (PTree NameInfo), meas2fun: Map Name Name, offset: Int, nbrMeas: Int, alive: Set Int }
```
...
## Languages  
          ...
          <DocBlock title="DependencyAnalysis" kind="lang" link="/docs/Stdlib/tuning/dependency-analysis.mc/lang-DependencyAnalysis">
...
```
          ...
          <DocBlock title="TestLang" kind="lang" link="/docs/Stdlib/tuning/dependency-analysis.mc/lang-TestLang">
...
## Variables  
          ...
          <DocBlock title="_dependencyGraphEmpty" kind="let">

```mc
let _dependencyGraphEmpty  : {alive: Set Int, graph: Digraph Int Int, offset: Int, nbrMeas: Int, meas2fun: Map Name Name, measuringPoints: Map Name (PTree NameInfo)}
```
