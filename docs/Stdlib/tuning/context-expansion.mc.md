...
<a href={"/docs/Stdlib/mexpr/mexpr.mc"} style={S.link}>mexpr/mexpr.mc</a>, <a href={"/docs/Stdlib/mexpr/pprint.mc"} style={S.link}>mexpr/pprint.mc</a>, <a href={"/docs/Stdlib/mexpr/eq.mc"} style={S.link}>mexpr/eq.mc</a>, <a href={"/docs/Stdlib/mexpr/utils.mc"} style={S.link}>mexpr/utils.mc</a>, <a href={"/docs/Stdlib/mexpr/anf.mc"} style={S.link}>mexpr/anf.mc</a>, <a href={"/docs/Stdlib/mexpr/ast-builder.mc"} style={S.link}>mexpr/ast-builder.mc</a>, <a href={"/docs/Stdlib/sys.mc"} style={S.link}>sys.mc</a>, <a href={"/docs/Stdlib/digraph.mc"} style={S.link}>digraph.mc</a>, <a href={"/docs/Stdlib/tuning/graph-coloring.mc"} style={S.link}>graph-coloring.mc</a>  
  
## Types  
  

          <DocBlock title="LookupTable" kind="type">
...
```
          ...
          <DocBlock title="ContextExpanded" kind="type">

```mc
type ContextExpanded : { table: LookupTable, tempDir: String, tempFile: String, cleanup: () -> () }
```
...
## Languages  
          ...
          <DocBlock title="ContextExpand" kind="lang" link="/docs/Stdlib/tuning/context-expansion.mc/lang-ContextExpand">

```mc
lang ContextExpand
```

<Description>{`Fragment for transforming a program with holes.`}</Description>
...
```
          ...
          <DocBlock title="MExprHoles" kind="lang" link="/docs/Stdlib/tuning/context-expansion.mc/lang-MExprHoles">
...
```
          ...
          <DocBlock title="HolesPrettyPrint" kind="lang" link="/docs/Stdlib/tuning/context-expansion.mc/lang-HolesPrettyPrint">

```mc
lang HolesPrettyPrint
```
...
```
          ...
          <DocBlock title="TestLang" kind="lang" link="/docs/Stdlib/tuning/context-expansion.mc/lang-TestLang">
...
## Variables  
          ...
          <DocBlock title="contextExpansionTableName" kind="let">

```mc
let contextExpansionTableName  : Name
```
...
```
          ...
          <DocBlock title="contextExpansionLookupCallCtx" kind="let">

```mc
let contextExpansionLookupCallCtx lookup tree incVarName env : (Int -> Ast_Expr) -> PTree NameInfo -> Name -> CallCtxEnv -> Ast_Expr
```

<Description>{`Generate code for looking up a value of a hole depending on its call history`}</Description>
