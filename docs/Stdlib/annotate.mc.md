...
<a href={"/docs/Stdlib/option.mc"} style={S.link}>option.mc</a>, <a href={"/docs/Stdlib/mexpr/info.mc"} style={S.link}>mexpr/info.mc</a>, <a href={"/docs/Stdlib/map.mc"} style={S.link}>map.mc</a>, <a href={"/docs/Stdlib/stringid.mc"} style={S.link}>stringid.mc</a>  
  
## Languages  
  

          <DocBlock title="Annotator" kind="lang" link="/docs/Stdlib/annotate.mc/lang-Annotator">
...
```
          ...
          <DocBlock title="HtmlAnnotator" kind="lang" link="/docs/Stdlib/annotate.mc/lang-HtmlAnnotator">
...
## Variables  
          ...
          <DocBlock title="_templateBefore" kind="let">

```mc
let _templateBefore  : String
```

<Description>{`NOTE\(vipa, 2022\-08\-25\): This isn't the greatest, but it works`}</Description>
...
```
          ...
          <DocBlock title="_templateAfter" kind="let">

```mc
let _templateAfter  : String
```
...
```
          ...
          <DocBlock title="_escapeHtmlChar" kind="let">

```mc
let _escapeHtmlChar c : Char -> String
```
