...
<a href={"/docs/Stdlib/parser/selfhost-gen.mc"} style={S.link}>selfhost-gen.mc</a>, <a href={"/docs/Stdlib/parser/gen-ast.mc"} style={S.link}>gen-ast.mc</a>, <a href={"/docs/Stdlib/parser/gen-op-ast.mc"} style={S.link}>gen-op-ast.mc</a>, <a href={"/docs/Stdlib/math.mc"} style={S.link}>math.mc</a>, <a href={"/docs/Stdlib/result.mc"} style={S.link}>result.mc</a>, <a href={"/docs/Stdlib/seq.mc"} style={S.link}>seq.mc</a>, <a href={"/docs/Stdlib/mexpr/cmp.mc"} style={S.link}>mexpr/cmp.mc</a>, <a href={"/docs/Stdlib/mexpr/boot-parser.mc"} style={S.link}>mexpr/boot-parser.mc</a>, <a href={"/docs/Stdlib/mlang/pprint.mc"} style={S.link}>mlang/pprint.mc</a>  
  
## Types  
  

          <DocBlock title="Res" kind="type">
...
## Languages  
          ...
          <DocBlock title="PreToken" kind="lang" link="/docs/Stdlib/parser/tool.mc/lang-PreToken">

```mc
lang PreToken
```

<Description>{`NOTE\(vipa, 2022\-04\-05\): A token type only ever intended for  
analysis, thus only containing a TokenRepr, no Token. This is used  
for all tokens declared with the \`token\` declaration.`}</Description>
...
```
          ...
          <DocBlock title="PreLitToken" kind="lang" link="/docs/Stdlib/parser/tool.mc/lang-PreLitToken">

```mc
lang PreLitToken
```

<Description>{`NOTE\(vipa, 2022\-04\-25\): Similar to PreToken, these are only  
...
\*generating\* code, we only have that in the \*generated\* code.`}</Description>
...
```
          ...
          <DocBlock title="LL1Analysis" kind="lang" link="/docs/Stdlib/parser/tool.mc/lang-LL1Analysis">
...
```
          ...
          <DocBlock title="Fragments" kind="lang" link="/docs/Stdlib/parser/tool.mc/lang-Fragments">
...
## Variables  
          ...
          <DocBlock title="runParserGenerator" kind="let">

```mc
let runParserGenerator args : {outFile: String, synFile: String} -> ()
```
