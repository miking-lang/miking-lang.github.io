...
<a href={"/docs/Stdlib/string.mc"} style={S.link}>string.mc</a>, <a href={"/docs/Stdlib/seq.mc"} style={S.link}>seq.mc</a>, <a href={"/docs/Stdlib/mexpr/info.mc"} style={S.link}>mexpr/info.mc</a>, <a href={"/docs/Stdlib/parser/grammar.mc"} style={S.link}>grammar.mc</a>  
  
## Languages  
  

          <DocBlock title="WSACParser" kind="lang" link="/docs/Stdlib/parser/lexer.mc/lang-WSACParser">

```mc
lang WSACParser
```

<Description>{`Base language for whitespace and comments \(WSAC\) parsing`}</Description>
...
```
          ...
          <DocBlock title="TokenParser" kind="lang" link="/docs/Stdlib/parser/lexer.mc/lang-TokenParser">

```mc
lang TokenParser
```

<Description>{`Base language for parsing tokens preceeded by WSAC`}</Description>
...
```
          ...
          <DocBlock title="WhitespaceParser" kind="lang" link="/docs/Stdlib/parser/lexer.mc/lang-WhitespaceParser">

```mc
lang WhitespaceParser
```

<Description>{`Eats whitespace`}</Description>
...
```
          ...
          <DocBlock title="LineCommentParser" kind="lang" link="/docs/Stdlib/parser/lexer.mc/lang-LineCommentParser">

```mc
lang LineCommentParser
```

<Description>{`Eat line comments of the form \-\-`}</Description>
...
```
          ...
          <DocBlock title="MultilineCommentParser" kind="lang" link="/docs/Stdlib/parser/lexer.mc/lang-MultilineCommentParser">

```mc
lang MultilineCommentParser
```

<Description>{`Eat multiline comment of the form /\-  \-/`}</Description>
...
```
          ...
          <DocBlock title="MExprWSACParser" kind="lang" link="/docs/Stdlib/parser/lexer.mc/lang-MExprWSACParser">
...
```
          ...
          <DocBlock title="ErrorTokenParser" kind="lang" link="/docs/Stdlib/parser/lexer.mc/lang-ErrorTokenParser">

```mc
lang ErrorTokenParser
```
...
```
          ...
          <DocBlock title="EOFTokenParser" kind="lang" link="/docs/Stdlib/parser/lexer.mc/lang-EOFTokenParser">
...
```
          ...
          <DocBlock title="LIdentTokenParser" kind="lang" link="/docs/Stdlib/parser/lexer.mc/lang-LIdentTokenParser">
...
```
          ...
          <DocBlock title="UIdentTokenParser" kind="lang" link="/docs/Stdlib/parser/lexer.mc/lang-UIdentTokenParser">
...
```
          ...
          <DocBlock title="UIntTokenParser" kind="lang" link="/docs/Stdlib/parser/lexer.mc/lang-UIntTokenParser">
...
```
          ...
          <DocBlock title="UFloatTokenParser" kind="lang" link="/docs/Stdlib/parser/lexer.mc/lang-UFloatTokenParser">

```mc
lang UFloatTokenParser
```
...
```
          ...
          <DocBlock title="OperatorTokenParser" kind="lang" link="/docs/Stdlib/parser/lexer.mc/lang-OperatorTokenParser">
...
```
          ...
          <DocBlock title="BracketTokenParser" kind="lang" link="/docs/Stdlib/parser/lexer.mc/lang-BracketTokenParser">
...
```
          ...
          <DocBlock title="SemiTokenParser" kind="lang" link="/docs/Stdlib/parser/lexer.mc/lang-SemiTokenParser">
...
```
          ...
          <DocBlock title="CommaTokenParser" kind="lang" link="/docs/Stdlib/parser/lexer.mc/lang-CommaTokenParser">
...
```
          ...
          <DocBlock title="StringTokenParser" kind="lang" link="/docs/Stdlib/parser/lexer.mc/lang-StringTokenParser">
...
```
          ...
          <DocBlock title="CharTokenParser" kind="lang" link="/docs/Stdlib/parser/lexer.mc/lang-CharTokenParser">

```mc
lang CharTokenParser
```
...
```
          ...
          <DocBlock title="HashStringTokenParser" kind="lang" link="/docs/Stdlib/parser/lexer.mc/lang-HashStringTokenParser">
...
```
          ...
          <DocBlock title="Lexer" kind="lang" link="/docs/Stdlib/parser/lexer.mc/lang-Lexer">
...
## Variables  
          ...
          <DocBlock title="tabSpace" kind="let">
...
```
          ...
          <DocBlock title="parseIdentCont" kind="let">

```mc
let parseIdentCont p str : Pos -> String -> {pos: Pos, str: String, val: String}
```

<Description>{`Parses the continuation of an identifier, i.e., upper and lower  
case letters, digits, and underscore.`}</Description>
...
```
          ...
          <DocBlock title="parseOperatorCont" kind="let">

```mc
let parseOperatorCont p str : Pos -> String -> {val: String, stream: {pos: Pos, str: String}}
```
