...
<a href={"/docs/Stdlib/common.mc"} style={S.link}>common.mc</a>, <a href={"/docs/Stdlib/map.mc"} style={S.link}>map.mc</a>, <a href={"/docs/Stdlib/math.mc"} style={S.link}>math.mc</a>, <a href={"/docs/Stdlib/name.mc"} style={S.link}>name.mc</a>, <a href={"/docs/Stdlib/set.mc"} style={S.link}>set.mc</a>, <a href={"/docs/Stdlib/string.mc"} style={S.link}>string.mc</a>, <a href={"/docs/Stdlib/mexpr/ast.mc"} style={S.link}>mexpr/ast.mc</a>, <a href={"/docs/Stdlib/mexpr/ast-builder.mc"} style={S.link}>mexpr/ast-builder.mc</a>, <a href={"/docs/Stdlib/mexpr/cmp.mc"} style={S.link}>mexpr/cmp.mc</a>  
  
## Languages  
  

          <DocBlock title="TokenReprBase" kind="lang" link="/docs/Stdlib/parser/grammar.mc/lang-TokenReprBase">

```mc
lang TokenReprBase
```

<Description>{`Base language for tokens`}</Description>
...
```
          ...
          <DocBlock title="TokenReprEOF" kind="lang" link="/docs/Stdlib/parser/grammar.mc/lang-TokenReprEOF">
...
```
          ...
          <DocBlock title="ContextFreeGrammar" kind="lang" link="/docs/Stdlib/parser/grammar.mc/lang-ContextFreeGrammar">

```mc
lang ContextFreeGrammar
```

<Description>{`TODO\(johnwikman, 2023\-05\-13\): Ast inclusion is temporary until polymorphism  
properly works in MLang. Remove this when polymorhpism works such that the  
type is available in the body, and generalize the Expr uses`}</Description>
...
```
          ...
          <DocBlock title="GrammarTestLanguage" kind="lang" link="/docs/Stdlib/parser/grammar.mc/lang-GrammarTestLanguage">

```mc
lang GrammarTestLanguage
```
