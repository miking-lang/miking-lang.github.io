...
<a href={"/docs/Stdlib/seq.mc"} style={S.link}>seq.mc</a>, <a href={"/docs/Stdlib/string.mc"} style={S.link}>string.mc</a>  
  
## Languages  
  

          <DocBlock title="JVMAst" kind="lang" link="/docs/Stdlib/jvm/ast.mc/lang-JVMAst">
...
## Variables  
          ...
          <DocBlock title="commaSeparateHelper" kind="let">

```mc
let commaSeparateHelper seq res : [String] -> String -> String
```
...
```
          ...
          <DocBlock title="commaSeparate" kind="let">

```mc
let commaSeparate seq : [String] -> String
```
...
```
          ...
          <DocBlock title="stringify" kind="let">

```mc
let stringify string : String -> String
```

<Description>{`TODO: make sure to escape`}</Description>
