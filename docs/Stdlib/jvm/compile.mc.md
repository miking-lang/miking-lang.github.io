...
<a href={"/docs/Stdlib/mexpr/ast.mc"} style={S.link}>mexpr/ast.mc</a>, <a href={"/docs/Stdlib/string.mc"} style={S.link}>string.mc</a>, <a href={"/docs/Stdlib/jvm/ast.mc"} style={S.link}>jvm/ast.mc</a>, <a href={"/docs/Stdlib/javascript/util.mc"} style={S.link}>javascript/util.mc</a>, <a href={"/docs/Stdlib/seq.mc"} style={S.link}>seq.mc</a>, <a href={"/docs/Stdlib/pmexpr/utils.mc"} style={S.link}>pmexpr/utils.mc</a>, <a href={"/docs/Stdlib/jvm/constants.mc"} style={S.link}>jvm/constants.mc</a>, <a href={"/docs/Stdlib/stdlib.mc"} style={S.link}>stdlib.mc</a>, <a href={"/docs/Stdlib/sys.mc"} style={S.link}>sys.mc</a>  
  
## Languages  
  

          <DocBlock title="MExprJVMCompile" kind="lang" link="/docs/Stdlib/jvm/compile.mc/lang-MExprJVMCompile">

```mc
lang MExprJVMCompile
```
...
## Variables  
          ...
          <DocBlock title="compileJVMEnv" kind="let">

```mc
let compileJVMEnv ast : Ast_Expr -> JVMAst_JVMProgram
```
...
```
          ...
          <DocBlock title="compileMCoreToJVM" kind="let">

```mc
let compileMCoreToJVM ast : Ast_Expr -> String
```
...
```
          ...
          <DocBlock title="getJarFiles" kind="let">

```mc
let getJarFiles tempDir : String -> ()
```
...
```
          ...
          <DocBlock title="compileJava" kind="let">

```mc
let compileJava outDir jarPath : String -> String -> ()
```
...
```
          ...
          <DocBlock title="modifyMainClassForTest" kind="let">

```mc
let modifyMainClassForTest prog : JVMAst_JVMProgram -> JVMAst_JVMProgram
```
...
```
          ...
          <DocBlock title="prepareForTests" kind="let">

```mc
let prepareForTests path : String -> ()
```
...
```
          ...
          <DocBlock title="jvmTmpPath" kind="let">

```mc
let jvmTmpPath  : String
```
...
```
          ...
          <DocBlock title="testJVM" kind="let">

```mc
let testJVM ast : Ast_Expr -> String
```
