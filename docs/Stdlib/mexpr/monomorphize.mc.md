...
<a href={"/docs/Stdlib/digraph.mc"} style={S.link}>digraph.mc</a>, <a href={"/docs/Stdlib/mexpr/ast.mc"} style={S.link}>mexpr/ast.mc</a>, <a href={"/docs/Stdlib/mexpr/call-graph.mc"} style={S.link}>mexpr/call-graph.mc</a>, <a href={"/docs/Stdlib/mexpr/cmp.mc"} style={S.link}>mexpr/cmp.mc</a>, <a href={"/docs/Stdlib/mexpr/eq.mc"} style={S.link}>mexpr/eq.mc</a>, <a href={"/docs/Stdlib/mexpr/eval.mc"} style={S.link}>mexpr/eval.mc</a>, <a href={"/docs/Stdlib/mexpr/pprint.mc"} style={S.link}>mexpr/pprint.mc</a>, <a href={"/docs/Stdlib/mexpr/symbolize.mc"} style={S.link}>mexpr/symbolize.mc</a>, <a href={"/docs/Stdlib/mexpr/type.mc"} style={S.link}>mexpr/type.mc</a>, <a href={"/docs/Stdlib/mexpr/type-check.mc"} style={S.link}>mexpr/type-check.mc</a>  
  
## Languages  
  

          <DocBlock title="Monomorphize" kind="lang" link="/docs/Stdlib/mexpr/monomorphize.mc/lang-Monomorphize">
...
```
          ...
          <DocBlock title="MonomorphizeValidate" kind="lang" link="/docs/Stdlib/mexpr/monomorphize.mc/lang-MonomorphizeValidate">

```mc
lang MonomorphizeValidate
```
...
```
          ...
          <DocBlock title="MonomorphizeInstantiate" kind="lang" link="/docs/Stdlib/mexpr/monomorphize.mc/lang-MonomorphizeInstantiate">

```mc
lang MonomorphizeInstantiate
```
...
```
          ...
          <DocBlock title="MonomorphizeResymbolize" kind="lang" link="/docs/Stdlib/mexpr/monomorphize.mc/lang-MonomorphizeResymbolize">

```mc
lang MonomorphizeResymbolize
```
...
```
          ...
          <DocBlock title="MonomorphizeCollect" kind="lang" link="/docs/Stdlib/mexpr/monomorphize.mc/lang-MonomorphizeCollect">
...
```
          ...
          <DocBlock title="MonomorphizeApply" kind="lang" link="/docs/Stdlib/mexpr/monomorphize.mc/lang-MonomorphizeApply">

```mc
lang MonomorphizeApply
```
...
```
          ...
          <DocBlock title="MExprMonomorphize" kind="lang" link="/docs/Stdlib/mexpr/monomorphize.mc/lang-MExprMonomorphize">
...
```
          ...
          <DocBlock title="MExprMonomorphizeTest" kind="lang" link="/docs/Stdlib/mexpr/monomorphize.mc/lang-MExprMonomorphizeTest">
