...
<a href={"/docs/Stdlib/set.mc"} style={S.link}>set.mc</a>, <a href={"/docs/Stdlib/mexpr/ast.mc"} style={S.link}>mexpr/ast.mc</a>, <a href={"/docs/Stdlib/mexpr/ast-builder.mc"} style={S.link}>mexpr/ast-builder.mc</a>, <a href={"/docs/Stdlib/mexpr/call-graph.mc"} style={S.link}>mexpr/call-graph.mc</a>, <a href={"/docs/Stdlib/mexpr/const-arity.mc"} style={S.link}>mexpr/const-arity.mc</a>  
  
## Types  
  

          <DocBlock title="SideEffectEnv" kind="type">

```mc
type SideEffectEnv : { sideEffectId: Set Name, arityId: Map Name Int }
```
...
## Languages  
          ...
          <DocBlock title="SideEffect" kind="lang" link="/docs/Stdlib/mexpr/side-effect.mc/lang-SideEffect">
...
```
          ...
          <DocBlock title="ConstSideEffectBase" kind="lang" link="/docs/Stdlib/mexpr/side-effect.mc/lang-ConstSideEffectBase">

```mc
lang ConstSideEffectBase
```
...
```
          ...
          <DocBlock title="ConstSideEffect" kind="lang" link="/docs/Stdlib/mexpr/side-effect.mc/lang-ConstSideEffect">

```mc
lang ConstSideEffect
```
...
```
          ...
          <DocBlock title="MExprSideEffect" kind="lang" link="/docs/Stdlib/mexpr/side-effect.mc/lang-MExprSideEffect">
