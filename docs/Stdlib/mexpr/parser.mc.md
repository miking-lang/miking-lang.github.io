...
<a href={"/docs/Stdlib/string.mc"} style={S.link}>string.mc</a>, <a href={"/docs/Stdlib/seq.mc"} style={S.link}>seq.mc</a>, <a href={"/docs/Stdlib/mexpr/ast.mc"} style={S.link}>ast.mc</a>, <a href={"/docs/Stdlib/mexpr/ast-builder.mc"} style={S.link}>ast-builder.mc</a>, <a href={"/docs/Stdlib/mexpr/eq.mc"} style={S.link}>eq.mc</a>, <a href={"/docs/Stdlib/mexpr/info.mc"} style={S.link}>info.mc</a>, <a href={"/docs/Stdlib/parser/lexer.mc"} style={S.link}>parser/lexer.mc</a>  
...
```
          ...
          <DocBlock title="StrPos" kind="type">
...
## Languages  
          ...
          <DocBlock title="MExprWSACParser" kind="lang" link="/docs/Stdlib/mexpr/parser.mc/lang-MExprWSACParser">

```mc
lang MExprWSACParser
```

<Description>{`Commbined WSAC parser for MExpr`}</Description>
...
```
          ...
          <DocBlock title="ExprParser" kind="lang" link="/docs/Stdlib/mexpr/parser.mc/lang-ExprParser">

```mc
lang ExprParser
```

<Description>{`Top of the expression parser. Connects WSAC with parsing of other non terminals`}</Description>
...
```
          ...
          <DocBlock title="ExprParserNoInfix" kind="lang" link="/docs/Stdlib/mexpr/parser.mc/lang-ExprParserNoInfix">

```mc
lang ExprParserNoInfix
```

<Description>{`Include this fragment if there are no infix operations`}</Description>
...
```
          ...
          <DocBlock title="IdentParser" kind="lang" link="/docs/Stdlib/mexpr/parser.mc/lang-IdentParser">

```mc
lang IdentParser
```

<Description>{`Parse identifier`}</Description>
...
```
          ...
          <DocBlock title="BoolParser" kind="lang" link="/docs/Stdlib/mexpr/parser.mc/lang-BoolParser">

```mc
lang BoolParser
```

<Description>{`Parsing of boolean literals`}</Description>
...
```
          ...
          <DocBlock title="UNumParser" kind="lang" link="/docs/Stdlib/mexpr/parser.mc/lang-UNumParser">

```mc
lang UNumParser
```

<Description>{`Parsing of an unsigned number`}</Description>
...
```
          ...
          <DocBlock title="UIntParser" kind="lang" link="/docs/Stdlib/mexpr/parser.mc/lang-UIntParser">

```mc
lang UIntParser
```

<Description>{`Parsing of an unsigned integer`}</Description>
...
```
          ...
          <DocBlock title="UFloatParser" kind="lang" link="/docs/Stdlib/mexpr/parser.mc/lang-UFloatParser">

```mc
lang UFloatParser
```

<Description>{`Parsing of an unsigned float`}</Description>
...
```
          ...
          <DocBlock title="KeywordUtils" kind="lang" link="/docs/Stdlib/mexpr/parser.mc/lang-KeywordUtils">

```mc
lang KeywordUtils
```

<Description>{`Fragment for simple parsing of keyword`}</Description>
...
```
          ...
          <DocBlock title="IfParser" kind="lang" link="/docs/Stdlib/mexpr/parser.mc/lang-IfParser">

```mc
lang IfParser
```

<Description>{`Parsing if expressions`}</Description>
...
```
          ...
          <DocBlock title="ParenthesesParser" kind="lang" link="/docs/Stdlib/mexpr/parser.mc/lang-ParenthesesParser">

```mc
lang ParenthesesParser
```

<Description>{`Parse parentheses`}</Description>
...
```
          ...
          <DocBlock title="SeqParser" kind="lang" link="/docs/Stdlib/mexpr/parser.mc/lang-SeqParser">

```mc
lang SeqParser
```

<Description>{`Parses a sequence of`}</Description>
...
```
          ...
          <DocBlock title="StringParser" kind="lang" link="/docs/Stdlib/mexpr/parser.mc/lang-StringParser">

```mc
lang StringParser
```

<Description>{`Parses strings, including escape characters`}</Description>
...
```
          ...
          <DocBlock title="CharParser" kind="lang" link="/docs/Stdlib/mexpr/parser.mc/lang-CharParser">

```mc
lang CharParser
```

<Description>{`Parses character literals`}</Description>
...
```
          ...
          <DocBlock title="VarParser" kind="lang" link="/docs/Stdlib/mexpr/parser.mc/lang-VarParser">
...
```
          ...
          <DocBlock title="FunParser" kind="lang" link="/docs/Stdlib/mexpr/parser.mc/lang-FunParser">

```mc
lang FunParser
```

<Description>{`Parsing of a lambda`}</Description>
...
```
          ...
          <DocBlock title="LetParser" kind="lang" link="/docs/Stdlib/mexpr/parser.mc/lang-LetParser">

```mc
lang LetParser
```

<Description>{`Parsing let expressions`}</Description>
...
```
          ...
          <DocBlock title="ExprInfixParser" kind="lang" link="/docs/Stdlib/mexpr/parser.mc/lang-ExprInfixParser">

```mc
lang ExprInfixParser
```

<Description>{`General fragment for handling infix operations`}</Description>
...
```
          ...
          <DocBlock title="ExprInfixParserClosed" kind="lang" link="/docs/Stdlib/mexpr/parser.mc/lang-ExprInfixParserClosed">

```mc
lang ExprInfixParserClosed
```

<Description>{`This parser should be used if juxtaposition is NOT used`}</Description>
...
```
          ...
          <DocBlock title="ExprInfixParserJuxtaposition" kind="lang" link="/docs/Stdlib/mexpr/parser.mc/lang-ExprInfixParserJuxtaposition">

```mc
lang ExprInfixParserJuxtaposition
```

<Description>{`This parser should be used for application using juxaposition`}</Description>
...
```
          ...
          <DocBlock title="MExprParserBase" kind="lang" link="/docs/Stdlib/mexpr/parser.mc/lang-MExprParserBase">

```mc
lang MExprParserBase
```
...
```
          ...
          <DocBlock title="MExprParser" kind="lang" link="/docs/Stdlib/mexpr/parser.mc/lang-MExprParser">
...
## Variables  
          ...
          <DocBlock title="parseIdent" kind="let">

```mc
let parseIdent upper p str : Bool -> Pos -> String -> {pos: Pos, str: String, val: String}
```

<Description>{`Parses an identfier that starts with a lower\-case letter or a '\_' if parameter  
...
If no identifier, the 'val' field contains an empty string.`}</Description>
...
```
          ...
          <DocBlock title="parseUInt" kind="let">

```mc
let parseUInt p str : Pos -> String -> {pos: Pos, str: String, val: String}
```
...
```
          ...
          <DocBlock title="parseFloatExponent" kind="let">

```mc
let parseFloatExponent p str : Pos -> String -> {pos: Pos, str: String, val: String}
```
...
```
          ...
          <DocBlock title="matchChar" kind="let">

```mc
let matchChar p str : Pos -> String -> {pos: Pos, str: String, val: Char}
```

<Description>{`Matches a character \(including escape character\).`}</Description>
