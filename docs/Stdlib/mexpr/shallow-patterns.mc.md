...
<a href={"/docs/Stdlib/either.mc"} style={S.link}>either.mc</a>, <a href={"/docs/Stdlib/mexpr/pprint.mc"} style={S.link}>mexpr/pprint.mc</a>, <a href={"/docs/Stdlib/mexpr/ast.mc"} style={S.link}>ast.mc</a>, <a href={"/docs/Stdlib/mexpr/ast-builder.mc"} style={S.link}>ast-builder.mc</a>, <a href={"/docs/Stdlib/common.mc"} style={S.link}>common.mc</a>, <a href={"/docs/Stdlib/seq.mc"} style={S.link}>seq.mc</a>, <a href={"/docs/Stdlib/set.mc"} style={S.link}>set.mc</a>  
  
## Languages  
  

          <DocBlock title="ShallowBase" kind="lang" link="/docs/Stdlib/mexpr/shallow-patterns.mc/lang-ShallowBase">
...
```
          ...
          <DocBlock title="ShallowAnd" kind="lang" link="/docs/Stdlib/mexpr/shallow-patterns.mc/lang-ShallowAnd">
...
```
          ...
          <DocBlock title="ShallowOr" kind="lang" link="/docs/Stdlib/mexpr/shallow-patterns.mc/lang-ShallowOr">
...
```
          ...
          <DocBlock title="ShallowNot" kind="lang" link="/docs/Stdlib/mexpr/shallow-patterns.mc/lang-ShallowNot">
...
```
          ...
          <DocBlock title="ShallowInt" kind="lang" link="/docs/Stdlib/mexpr/shallow-patterns.mc/lang-ShallowInt">
...
```
          ...
          <DocBlock title="ShallowChar" kind="lang" link="/docs/Stdlib/mexpr/shallow-patterns.mc/lang-ShallowChar">
...
```
          ...
          <DocBlock title="ShallowBool" kind="lang" link="/docs/Stdlib/mexpr/shallow-patterns.mc/lang-ShallowBool">
...
```
          ...
          <DocBlock title="ShallowRecord" kind="lang" link="/docs/Stdlib/mexpr/shallow-patterns.mc/lang-ShallowRecord">
...
```
          ...
          <DocBlock title="ShallowSeq" kind="lang" link="/docs/Stdlib/mexpr/shallow-patterns.mc/lang-ShallowSeq">
...
```
          ...
          <DocBlock title="ShallowCon" kind="lang" link="/docs/Stdlib/mexpr/shallow-patterns.mc/lang-ShallowCon">
...
```
          ...
          <DocBlock title="ShallowMExpr" kind="lang" link="/docs/Stdlib/mexpr/shallow-patterns.mc/lang-ShallowMExpr">
...
```
          ...
          <DocBlock title="CollectBranches" kind="lang" link="/docs/Stdlib/mexpr/shallow-patterns.mc/lang-CollectBranches">

```mc
lang CollectBranches
```
...
```
          ...
          <DocBlock title="LowerNestedPatterns" kind="lang" link="/docs/Stdlib/mexpr/shallow-patterns.mc/lang-LowerNestedPatterns">

```mc
lang LowerNestedPatterns
```
...
```
          ...
          <DocBlock title="MExprLowerNestedPatterns" kind="lang" link="/docs/Stdlib/mexpr/shallow-patterns.mc/lang-MExprLowerNestedPatterns">

```mc
lang MExprLowerNestedPatterns
```
...
## Variables  
          ...
          <DocBlock title="_empty" kind="let">

```mc
let _empty _ : all v. () -> Map Name v
```

<Description>{`TODO\(aathn, 2023\-05\-07\): Relax value restriction`}</Description>
...
```
          ...
          <DocBlock title="_singleton" kind="let">

```mc
let _singleton n p : all v. Name -> v -> Map Name v
```
...
```
          ...
          <DocBlock title="_emptySlices" kind="let">

```mc
let _emptySlices  : Map (Int, Int) Name
```
...
```
          ...
          <DocBlock title="_getSliceName" kind="let">

```mc
let _getSliceName margins slices : (Int, Int) -> Ref (Map (Int, Int) Name) -> Name
```
