...
<a href={"/docs/Stdlib/map.mc"} style={S.link}>map.mc</a>, <a href={"/docs/Stdlib/mexpr/ast.mc"} style={S.link}>mexpr/ast.mc</a>, <a href={"/docs/Stdlib/mexpr/ast-builder.mc"} style={S.link}>mexpr/ast-builder.mc</a>, <a href={"/docs/Stdlib/mexpr/cmp.mc"} style={S.link}>mexpr/cmp.mc</a>, <a href={"/docs/Stdlib/mexpr/const-types.mc"} style={S.link}>mexpr/const-types.mc</a>, <a href={"/docs/Stdlib/mexpr/eq.mc"} style={S.link}>mexpr/eq.mc</a>, <a href={"/docs/Stdlib/mexpr/pprint.mc"} style={S.link}>mexpr/pprint.mc</a>  
  
## Types  
  

          <DocBlock title="Level" kind="type">

```mc
type Level : Int
```

<Description>{`A level denotes the level in the AST that a type was introduced at`}</Description>
...
## Languages  
          ...
          <DocBlock title="MetaVarTypeAst" kind="lang" link="/docs/Stdlib/mexpr/type.mc/lang-MetaVarTypeAst">

```mc
lang MetaVarTypeAst
```

<Description>{`Unification meta variables.  These variables represent some  
specific but as\-of\-yet undetermined type.`}</Description>
...
```
          ...
          <DocBlock title="MetaVarTypeCmp" kind="lang" link="/docs/Stdlib/mexpr/type.mc/lang-MetaVarTypeCmp">
...
```
          ...
          <DocBlock title="MetaVarTypePrettyPrint" kind="lang" link="/docs/Stdlib/mexpr/type.mc/lang-MetaVarTypePrettyPrint">

```mc
lang MetaVarTypePrettyPrint
```
...
```
          ...
          <DocBlock title="MetaVarTypeEq" kind="lang" link="/docs/Stdlib/mexpr/type.mc/lang-MetaVarTypeEq">
...
```
          ...
          <DocBlock title="VarTypeSubstitute" kind="lang" link="/docs/Stdlib/mexpr/type.mc/lang-VarTypeSubstitute">

```mc
lang VarTypeSubstitute
```

<Description>{`Substitutes type variables`}</Description>
...
```
          ...
          <DocBlock title="AppTypeUtils" kind="lang" link="/docs/Stdlib/mexpr/type.mc/lang-AppTypeUtils">
...
```
          ...
          <DocBlock title="FunArity" kind="lang" link="/docs/Stdlib/mexpr/type.mc/lang-FunArity">
...
```
          ...
          <DocBlock title="Test" kind="lang" link="/docs/Stdlib/mexpr/type.mc/lang-Test">
...
## Variables  
          ...
          <DocBlock title="newnmetavar" kind="let">

```mc
let newnmetavar str kind level info : String -> Ast_Kind -> Level -> Info -> Ast_Type
```
...
```
          ...
          <DocBlock title="newmetavar" kind="let">

```mc
let newmetavar  : Ast_Kind -> Level -> Info -> Ast_Type
```
...
```
          ...
          <DocBlock title="newmonovar" kind="let">

```mc
let newmonovar  : Level -> Info -> Ast_Type
```
...
```
          ...
          <DocBlock title="newpolyvar" kind="let">

```mc
let newpolyvar  : Level -> Info -> Ast_Type
```
...
```
          ...
          <DocBlock title="newrecvar" kind="let">

```mc
let newrecvar fields : Map SID Ast_Type -> Level -> Info -> Ast_Type
```
...
```
          ...
          <DocBlock title="newvar" kind="let">

```mc
let newvar  : Level -> Info -> Ast_Type
```
...
```
          ...
          <DocBlock title="isHigherOrderFunType" kind="let">

```mc
let isHigherOrderFunType ty : Ast_Type -> Bool
```
