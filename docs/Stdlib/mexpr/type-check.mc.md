...
<a href={"/docs/Stdlib/error.mc"} style={S.link}>error.mc</a>, <a href={"/docs/Stdlib/math.mc"} style={S.link}>math.mc</a>, <a href={"/docs/Stdlib/tuple.mc"} style={S.link}>tuple.mc</a>, <a href={"/docs/Stdlib/seq.mc"} style={S.link}>seq.mc</a>, <a href={"/docs/Stdlib/mexpr/annotate.mc"} style={S.link}>mexpr/annotate.mc</a>, <a href={"/docs/Stdlib/mexpr/ast.mc"} style={S.link}>mexpr/ast.mc</a>, <a href={"/docs/Stdlib/mexpr/ast-builder.mc"} style={S.link}>mexpr/ast-builder.mc</a>, <a href={"/docs/Stdlib/mexpr/builtin.mc"} style={S.link}>mexpr/builtin.mc</a>, <a href={"/docs/Stdlib/mexpr/cmp.mc"} style={S.link}>mexpr/cmp.mc</a>, <a href={"/docs/Stdlib/mexpr/const-types.mc"} style={S.link}>mexpr/const-types.mc</a>, <a href={"/docs/Stdlib/mexpr/eq.mc"} style={S.link}>mexpr/eq.mc</a>, <a href={"/docs/Stdlib/mexpr/expansive.mc"} style={S.link}>mexpr/expansive.mc</a>, <a href={"/docs/Stdlib/mexpr/info.mc"} style={S.link}>mexpr/info.mc</a>, <a href={"/docs/Stdlib/mexpr/pattern-analysis.mc"} style={S.link}>mexpr/pattern-analysis.mc</a>, <a href={"/docs/Stdlib/mexpr/pprint.mc"} style={S.link}>mexpr/pprint.mc</a>, <a href={"/docs/Stdlib/mexpr/symbolize.mc"} style={S.link}>mexpr/symbolize.mc</a>, <a href={"/docs/Stdlib/mexpr/type.mc"} style={S.link}>mexpr/type.mc</a>, <a href={"/docs/Stdlib/mexpr/unify.mc"} style={S.link}>mexpr/unify.mc</a>, <a href={"/docs/Stdlib/mexpr/repr-ast.mc"} style={S.link}>mexpr/repr-ast.mc</a>, <a href={"/docs/Stdlib/extrec/ast.mc"} style={S.link}>extrec/ast.mc</a>  
  
## Types  
  

          <DocBlock title="ReprSubst" kind="type">
...
```
          ...
          <DocBlock title="ExtRecDefs" kind="type">

```mc
type ExtRecDefs : Map Name (Map String (Name, Type))
```
...
```
          ...
          <DocBlock title="ExtRecEnvType" kind="type">

```mc
type ExtRecEnvType : { defs: ExtRecDefs, tyDeps: Map Name (Set Name), labelTyDeps: Map Name (Map String (Set Name)), sumTypeNames: Set Name, payloadNames: Set Name }
```
...
```
          ...
          <DocBlock title="TCEnv" kind="type">

```mc
type TCEnv : { varEnv: Map Name Type, conEnv: Map Name (Level, Type), tyVarEnv: Map Name (Level, Kind), tyConEnv: Map Name (Level, [Name], Type), typeDeps: Map Name (Set Name), conDeps: Map Name (Set Name), matches: [Map Name NormPat], matchVars: Map Name Level, matchLvl: Level, currentLvl: Level, disableRecordPolymorphism: Bool, disableConstructorTypes: Bool, extRecordType: ExtRecEnvType, reptypes: { delayedReprUnifications: Ref [(ReprVar, ReprVar)], opNamesInScope: Map Name (Option (Name, SID)), reprEnv: Map Name ReprSubst, nextReprScope: Ref Int, inImpl: Bool, reprScope: Int } }
```
...
## Languages  
          ...
          <DocBlock title="RepTypesHelpers" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-RepTypesHelpers">

```mc
lang RepTypesHelpers
```
...
```
          ...
          <DocBlock title="TCUnify" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-TCUnify">
...
```
          ...
          <DocBlock title="VarTypeTCUnify" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-VarTypeTCUnify">
...
```
          ...
          <DocBlock title="DataTypeTCUnify" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-DataTypeTCUnify">

```mc
lang DataTypeTCUnify
```
...
```
          ...
          <DocBlock title="GetKind" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-GetKind">
...
```
          ...
          <DocBlock title="MetaVarTypeTCUnify" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-MetaVarTypeTCUnify">
...
```
          ...
          <DocBlock title="AllTypeTCUnify" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-AllTypeTCUnify">
...
```
          ...
          <DocBlock title="ConTypeTCUnify" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-ConTypeTCUnify">
...
```
          ...
          <DocBlock title="Generalize" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-Generalize">
...
```
          ...
          <DocBlock title="MetaVarTypeGeneralize" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-MetaVarTypeGeneralize">

```mc
lang MetaVarTypeGeneralize
```
...
```
          ...
          <DocBlock title="VarTypeGeneralize" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-VarTypeGeneralize">

```mc
lang VarTypeGeneralize
```
...
```
          ...
          <DocBlock title="AllTypeGeneralize" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-AllTypeGeneralize">

```mc
lang AllTypeGeneralize
```
...
```
          ...
          <DocBlock title="WildToMeta" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-WildToMeta">
...
```
          ...
          <DocBlock title="MetaVarDisableGeneralize" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-MetaVarDisableGeneralize">

```mc
lang MetaVarDisableGeneralize
```
...
```
          ...
          <DocBlock title="ResolveType" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-ResolveType">

```mc
lang ResolveType
```

<Description>{`resolveType resolves type aliases and checks that they are fully applied.  
NOTE\(aathn, 2023\-05\-10\): In the future, this should be replaced  
with something which also performs a proper kind check.`}</Description>
...
```
          ...
          <DocBlock title="SubstituteUnknown" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-SubstituteUnknown">

```mc
lang SubstituteUnknown
```
...
```
          ...
          <DocBlock title="SubstituteNewReprs" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-SubstituteNewReprs">

```mc
lang SubstituteNewReprs
```
...
```
          ...
          <DocBlock title="RemoveMetaVar" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-RemoveMetaVar">
...
```
          ...
          <DocBlock title="TypeCheck" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-TypeCheck">
...
```
          ...
          <DocBlock title="PatTypeCheck" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-PatTypeCheck">
...
```
          ...
          <DocBlock title="IsEmpty" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-IsEmpty">
...
```
          ...
          <DocBlock title="VarTypeCheck" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-VarTypeCheck">
...
```
          ...
          <DocBlock title="OpVarTypeCheck" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-OpVarTypeCheck">
...
```
          ...
          <DocBlock title="LamTypeCheck" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-LamTypeCheck">
...
```
          ...
          <DocBlock title="AppTypeCheck" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-AppTypeCheck">
...
```
          ...
          <DocBlock title="DeclTypeCheck" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-DeclTypeCheck">
...
```
          ...
          <DocBlock title="OpDeclTypeCheck" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-OpDeclTypeCheck">

```mc
lang OpDeclTypeCheck
```
...
```
          ...
          <DocBlock title="ReprDeclTypeCheck" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-ReprDeclTypeCheck">

```mc
lang ReprDeclTypeCheck
```
...
```
          ...
          <DocBlock title="PropagateTypeAnnot" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-PropagateTypeAnnot">

```mc
lang PropagateTypeAnnot
```
...
```
          ...
          <DocBlock title="LetTypeCheck" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-LetTypeCheck">
...
```
          ...
          <DocBlock title="ApplyReprSubsts" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-ApplyReprSubsts">

```mc
lang ApplyReprSubsts
```
...
```
          ...
          <DocBlock title="OpImplTypeCheck" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-OpImplTypeCheck">

```mc
lang OpImplTypeCheck
```
...
```
          ...
          <DocBlock title="RecLetsTypeCheck" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-RecLetsTypeCheck">

```mc
lang RecLetsTypeCheck
```
...
```
          ...
          <DocBlock title="MatchTypeCheck" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-MatchTypeCheck">
...
```
          ...
          <DocBlock title="ConstTypeCheck" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-ConstTypeCheck">
...
```
          ...
          <DocBlock title="SeqTypeCheck" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-SeqTypeCheck">
...
```
          ...
          <DocBlock title="RecordTypeCheck" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-RecordTypeCheck">

```mc
lang RecordTypeCheck
```
...
```
          ...
          <DocBlock title="RecordUpdateTypeCheck" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-RecordUpdateTypeCheck">

```mc
lang RecordUpdateTypeCheck
```
...
```
          ...
          <DocBlock title="TypeTypeCheck" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-TypeTypeCheck">
...
```
          ...
          <DocBlock title="DataTypeCheck" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-DataTypeCheck">
...
```
          ...
          <DocBlock title="UtestTypeCheck" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-UtestTypeCheck">
...
```
          ...
          <DocBlock title="NeverTypeCheck" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-NeverTypeCheck">
...
```
          ...
          <DocBlock title="PlaceholderTypeCheck" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-PlaceholderTypeCheck">

```mc
lang PlaceholderTypeCheck
```
...
```
          ...
          <DocBlock title="ExtTypeCheck" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-ExtTypeCheck">
...
```
          ...
          <DocBlock title="NamedPatTypeCheck" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-NamedPatTypeCheck">

```mc
lang NamedPatTypeCheck
```
...
```
          ...
          <DocBlock title="SeqTotPatTypeCheck" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-SeqTotPatTypeCheck">

```mc
lang SeqTotPatTypeCheck
```
...
```
          ...
          <DocBlock title="SeqEdgePatTypeCheck" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-SeqEdgePatTypeCheck">

```mc
lang SeqEdgePatTypeCheck
```
...
```
          ...
          <DocBlock title="SeqPatIsEmpty" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-SeqPatIsEmpty">
...
```
          ...
          <DocBlock title="RecordPatTypeCheck" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-RecordPatTypeCheck">

```mc
lang RecordPatTypeCheck
```
...
```
          ...
          <DocBlock title="RecordPatIsEmpty" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-RecordPatIsEmpty">

```mc
lang RecordPatIsEmpty
```
...
```
          ...
          <DocBlock title="DataPatTypeCheck" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-DataPatTypeCheck">

```mc
lang DataPatTypeCheck
```
...
```
          ...
          <DocBlock title="ConPatIsEmpty" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-ConPatIsEmpty">
...
```
          ...
          <DocBlock title="IntPatTypeCheck" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-IntPatTypeCheck">

```mc
lang IntPatTypeCheck
```
...
```
          ...
          <DocBlock title="CharPatTypeCheck" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-CharPatTypeCheck">

```mc
lang CharPatTypeCheck
```
...
```
          ...
          <DocBlock title="BoolPatTypeCheck" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-BoolPatTypeCheck">

```mc
lang BoolPatTypeCheck
```
...
```
          ...
          <DocBlock title="AndPatTypeCheck" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-AndPatTypeCheck">

```mc
lang AndPatTypeCheck
```
...
```
          ...
          <DocBlock title="OrPatTypeCheck" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-OrPatTypeCheck">
...
```
          ...
          <DocBlock title="NotPatTypeCheck" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-NotPatTypeCheck">

```mc
lang NotPatTypeCheck
```
...
```
          ...
          <DocBlock title="MExprTypeCheckLamLetVar" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-MExprTypeCheckLamLetVar">

```mc
lang MExprTypeCheckLamLetVar
```
...
```
          ...
          <DocBlock title="MExprTypeCheckMost" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-MExprTypeCheckMost">
...
```
          ...
          <DocBlock title="MExprTypeCheck" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-MExprTypeCheck">
...
```
          ...
          <DocBlock title="RepTypesTypeCheck" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-RepTypesTypeCheck">

```mc
lang RepTypesTypeCheck
```
...
```
          ...
          <DocBlock title="TyAnnot" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-TyAnnot">

```mc
lang TyAnnot
```

<Description>{`NOTE\(vipa, 2022\-10\-07\): This can't use AnnotateMExprBase because it  
...
```
          ...
          <DocBlock title="PprintTyAnnot" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-PprintTyAnnot">
...
```
          ...
          <DocBlock title="TestLang" kind="lang" link="/docs/Stdlib/mexpr/type-check.mc/lang-TestLang">
...
## Variables  
          ...
          <DocBlock title="typcheckEnvEmpty" kind="let">
...
```
          ...
          <DocBlock title="typecheckEnvAddBuiltinTypes" kind="let">

```mc
let typecheckEnvAddBuiltinTypes env tys : TCEnv -> [(String, Name, [String])] -> TCEnv
```
...
```
          ...
          <DocBlock title="typcheckEnvDefault" kind="let">

```mc
let typcheckEnvDefault  : TCEnv
```
...
```
          ...
          <DocBlock title="_tcEnvEmpty" kind="let">
...
```
          ...
          <DocBlock title="_insertVar" kind="let">

```mc
let _insertVar name ty env : Name -> Ast_Type -> TCEnv -> TCEnv
```
...
```
          ...
          <DocBlock title="_computeUniverse" kind="let">

```mc
let _computeUniverse env ident : TCEnv -> Name -> Map Name (Set Name)
```
