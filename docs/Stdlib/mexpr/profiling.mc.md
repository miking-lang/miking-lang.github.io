...
<a href={"/docs/Stdlib/mexpr/ast.mc"} style={S.link}>mexpr/ast.mc</a>, <a href={"/docs/Stdlib/mexpr/boot-parser.mc"} style={S.link}>mexpr/boot-parser.mc</a>, <a href={"/docs/Stdlib/mexpr/eval.mc"} style={S.link}>mexpr/eval.mc</a>, <a href={"/docs/Stdlib/mexpr/symbolize.mc"} style={S.link}>mexpr/symbolize.mc</a>, <a href={"/docs/Stdlib/sys.mc"} style={S.link}>sys.mc</a>  
  
## Types  
  

          <DocBlock title="ProfileEnv" kind="type">
...
## Languages  
          ...
          <DocBlock title="MExprProfileInstrument" kind="lang" link="/docs/Stdlib/mexpr/profiling.mc/lang-MExprProfileInstrument">

```mc
lang MExprProfileInstrument
```
...
```
          ...
          <DocBlock title="TestLang" kind="lang" link="/docs/Stdlib/mexpr/profiling.mc/lang-TestLang">
...
## Variables  
          ...
          <DocBlock title="profilingResultFileName" kind="let">

```mc
let profilingResultFileName  : String
```
...
```
          ...
          <DocBlock title="_profilerInitStr" kind="let">

```mc
let _profilerInitStr env : Map Name (Int, Info) -> String
```
...
```
          ...
          <DocBlock title="_profilerReportStr" kind="let">

```mc
let _profilerReportStr  : String
```
...
```
          ...
          <DocBlock title="_profilerReportCodeRef" kind="let">

```mc
let _profilerReportCodeRef  : Ref (Option Ast_Expr)
```
...
```
          ...
          <DocBlock title="getProfilerReportCode" kind="let">

```mc
let getProfilerReportCode _ : all a. a -> Ast_Expr
```
