...
<a href={"/docs/Stdlib/result.mc"} style={S.link}>result.mc</a>, <a href={"/docs/Stdlib/mexpr/ast.mc"} style={S.link}>ast.mc</a>, <a href={"/docs/Stdlib/mexpr/eq.mc"} style={S.link}>eq.mc</a>, <a href={"/docs/Stdlib/mexpr/boot-parser.mc"} style={S.link}>boot-parser.mc</a>  
  
## Languages  
  

          <DocBlock title="AstResult" kind="lang" link="/docs/Stdlib/mexpr/ast-result.mc/lang-AstResult">
...
```
          ...
          <DocBlock title="TestLang" kind="lang" link="/docs/Stdlib/mexpr/ast-result.mc/lang-TestLang">
