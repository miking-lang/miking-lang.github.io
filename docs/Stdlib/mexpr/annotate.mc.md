...
<a href={"/docs/Stdlib/annotate.mc"} style={S.link}>../annotate.mc</a>, <a href={"/docs/Stdlib/mexpr/ast.mc"} style={S.link}>ast.mc</a>  
  
## Languages  
  

          <DocBlock title="AnnotateSources" kind="lang" link="/docs/Stdlib/mexpr/annotate.mc/lang-AnnotateSources">

```mc
lang AnnotateSources
```
...
```
          ...
          <DocBlock title="AnnotateMExprBase" kind="lang" link="/docs/Stdlib/mexpr/annotate.mc/lang-AnnotateMExprBase">

```mc
lang AnnotateMExprBase
```
