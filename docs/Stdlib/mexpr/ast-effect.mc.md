...
<a href={"/docs/Stdlib/effect.mc"} style={S.link}>effect.mc</a>, <a href={"/docs/Stdlib/mexpr/ast.mc"} style={S.link}>ast.mc</a>, <a href={"/docs/Stdlib/mexpr/eq.mc"} style={S.link}>eq.mc</a>, <a href={"/docs/Stdlib/mexpr/boot-parser.mc"} style={S.link}>boot-parser.mc</a>  
  
## Languages  
  

          <DocBlock title="AstEffect" kind="lang" link="/docs/Stdlib/mexpr/ast-effect.mc/lang-AstEffect">
...
```
          ...
          <DocBlock title="TestLang" kind="lang" link="/docs/Stdlib/mexpr/ast-effect.mc/lang-TestLang">
...
```
          ...
          <DocBlock title="TestLangImpl" kind="lang" link="/docs/Stdlib/mexpr/ast-effect.mc/lang-TestLangImpl">
