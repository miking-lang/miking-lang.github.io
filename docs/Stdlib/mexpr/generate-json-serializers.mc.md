...
<a href={"/docs/Stdlib/mexpr/ast.mc"} style={S.link}>ast.mc</a>, <a href={"/docs/Stdlib/mexpr/eq.mc"} style={S.link}>eq.mc</a>, <a href={"/docs/Stdlib/mexpr/cmp.mc"} style={S.link}>cmp.mc</a>, <a href={"/docs/Stdlib/mexpr/boot-parser.mc"} style={S.link}>boot-parser.mc</a>, <a href={"/docs/Stdlib/mexpr/pprint.mc"} style={S.link}>pprint.mc</a>, <a href={"/docs/Stdlib/mexpr/symbolize.mc"} style={S.link}>symbolize.mc</a>, <a href={"/docs/Stdlib/mexpr/type.mc"} style={S.link}>type.mc</a>, <a href={"/docs/Stdlib/mexpr/utils.mc"} style={S.link}>utils.mc</a>, <a href={"/docs/Stdlib/mexpr/duplicate-code-elimination.mc"} style={S.link}>duplicate-code-elimination.mc</a>, <a href={"/docs/Stdlib/mlang/loader.mc"} style={S.link}>mlang/loader.mc</a>, <a href={"/docs/Stdlib/json.mc"} style={S.link}>json.mc</a>, <a href={"/docs/Stdlib/stdlib.mc"} style={S.link}>stdlib.mc</a>, <a href={"/docs/Stdlib/stringid.mc"} style={S.link}>stringid.mc</a>, <a href={"/docs/Stdlib/map.mc"} style={S.link}>map.mc</a>  
  
## Languages  
  

          <DocBlock title="GenerateJsonSerializers" kind="lang" link="/docs/Stdlib/mexpr/generate-json-serializers.mc/lang-GenerateJsonSerializers">
...
```
          ...
          <DocBlock title="JsonSerializationLoader" kind="lang" link="/docs/Stdlib/mexpr/generate-json-serializers.mc/lang-JsonSerializationLoader">

```mc
lang JsonSerializationLoader
```
...
```
          ...
          <DocBlock title="Test" kind="lang" link="/docs/Stdlib/mexpr/generate-json-serializers.mc/lang-Test">
...
## Variables  
          ...
          <DocBlock title="constructorKey" kind="let">

```mc
let constructorKey  : String
```
...
```
          ...
          <DocBlock title="dataKey" kind="let">
