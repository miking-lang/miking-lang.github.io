...
<a href={"/docs/Stdlib/math.mc"} style={S.link}>math.mc</a>, <a href={"/docs/Stdlib/mexpr/cmp.mc"} style={S.link}>mexpr/cmp.mc</a>, <a href={"/docs/Stdlib/mexpr/eq.mc"} style={S.link}>mexpr/eq.mc</a>, <a href={"/docs/Stdlib/mexpr/type-check.mc"} style={S.link}>mexpr/type-check.mc</a>, <a href={"/docs/Stdlib/mexpr/pprint.mc"} style={S.link}>mexpr/pprint.mc</a>  
  
## Types  
  

          <DocBlock title="PosIndex" kind="type">
...
```
          ...
          <DocBlock title="ProgramPos" kind="type">
...
```
          ...
          <DocBlock title="ExprStatus" kind="type">
...
```
          ...
          <DocBlock title="CSESearchEnv" kind="type">

```mc
type CSESearchEnv : { index: PosIndex, subexprs: Map Expr ExprStatus, recursiveIdents: Set Name }
```
...
```
          ...
          <DocBlock title="CSEApplyEnv" kind="type">

```mc
type CSEApplyEnv : { index: PosIndex, posToSubexpr: Map PosIndex [(Name, Expr)], exprIdent: Map Expr Name }
```
...
```
          ...
          <DocBlock title="Multiple" kind="con">
...
## Languages  
          ...
          <DocBlock title="CSE" kind="lang" link="/docs/Stdlib/mexpr/cse.mc/lang-CSE">
...
```
          ...
          <DocBlock title="AppCSE" kind="lang" link="/docs/Stdlib/mexpr/cse.mc/lang-AppCSE">
...
```
          ...
          <DocBlock title="LamCSE" kind="lang" link="/docs/Stdlib/mexpr/cse.mc/lang-LamCSE">
...
```
          ...
          <DocBlock title="LetCSE" kind="lang" link="/docs/Stdlib/mexpr/cse.mc/lang-LetCSE">
...
```
          ...
          <DocBlock title="RecLetsCSE" kind="lang" link="/docs/Stdlib/mexpr/cse.mc/lang-RecLetsCSE">
...
```
          ...
          <DocBlock title="MatchCSE" kind="lang" link="/docs/Stdlib/mexpr/cse.mc/lang-MatchCSE">
...
```
          ...
          <DocBlock title="RecordCSE" kind="lang" link="/docs/Stdlib/mexpr/cse.mc/lang-RecordCSE">
...
```
          ...
          <DocBlock title="DataCSE" kind="lang" link="/docs/Stdlib/mexpr/cse.mc/lang-DataCSE">
...
```
          ...
          <DocBlock title="MExprCSE" kind="lang" link="/docs/Stdlib/mexpr/cse.mc/lang-MExprCSE">
...
```
          ...
          <DocBlock title="TestLang" kind="lang" link="/docs/Stdlib/mexpr/cse.mc/lang-TestLang">
...
## Variables  
          ...
          <DocBlock title="programPosLCP" kind="let">

```mc
let programPosLCP t1 t2 : ProgramPos -> ProgramPos -> ProgramPos
```

<Description>{`Finds the longest common prefix of two program positions.`}</Description>
