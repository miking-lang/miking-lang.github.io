...
## Types  
          ...
          <DocBlock title="RecordAddMergedRecord" kind="type">

```mc
type RecordAddMergedRecord : { info: Info, left: Merged, fields: [{ ty: Option Merged, label: { i: Info, v: String }, value: Option Merged }] }
```
