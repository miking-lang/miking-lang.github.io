...
<a href={"/docs/Stdlib/mexpr/ast.mc"} style={S.link}>ast.mc</a>, <a href={"/docs/Stdlib/mexpr/info.mc"} style={S.link}>info.mc</a>, <a href={"/docs/Stdlib/error.mc"} style={S.link}>error.mc</a>, <a href={"/docs/Stdlib/mexpr/ast-builder.mc"} style={S.link}>ast-builder.mc</a>, <a href={"/docs/Stdlib/mexpr/eq.mc"} style={S.link}>eq.mc</a>  
  
## Languages  
  

          <DocBlock title="KeywordMakerBase" kind="lang" link="/docs/Stdlib/mexpr/keyword-maker.mc/lang-KeywordMakerBase">

```mc
lang KeywordMakerBase
```

<Description>{`The base fragment that includes the keyword maker, but  
no checks for incorrect bindings in e.g. let or lam.  
See the separate fragments to include this.`}</Description>
...
```
          ...
          <DocBlock title="KeywordMakerData" kind="lang" link="/docs/Stdlib/mexpr/keyword-maker.mc/lang-KeywordMakerData">

```mc
lang KeywordMakerData
```

<Description>{`Support for keywords starting with capital letter. Uses ConApp and ConDef`}</Description>
...
```
          ...
          <DocBlock title="KeywordMakerType" kind="lang" link="/docs/Stdlib/mexpr/keyword-maker.mc/lang-KeywordMakerType">

```mc
lang KeywordMakerType
```
...
```
          ...
          <DocBlock title="KeywordMakerLam" kind="lang" link="/docs/Stdlib/mexpr/keyword-maker.mc/lang-KeywordMakerLam">

```mc
lang KeywordMakerLam
```

<Description>{`Includes a check that a keyword cannot be used as a binding variable in a lambda`}</Description>
...
```
          ...
          <DocBlock title="KeywordMakerLet" kind="lang" link="/docs/Stdlib/mexpr/keyword-maker.mc/lang-KeywordMakerLet">

```mc
lang KeywordMakerLet
```

<Description>{`Includes a check that a keyword cannot be used as a binding variable in a let expression`}</Description>
...
```
          ...
          <DocBlock title="KeywordMakerMatch" kind="lang" link="/docs/Stdlib/mexpr/keyword-maker.mc/lang-KeywordMakerMatch">

```mc
lang KeywordMakerMatch
```

<Description>{`Includes a check that a keyword cannot be used inside a pattern \(inside match\)`}</Description>
...
```
          ...
          <DocBlock title="KeywordMaker" kind="lang" link="/docs/Stdlib/mexpr/keyword-maker.mc/lang-KeywordMaker">

```mc
lang KeywordMaker
```

<Description>{`The keyword maker fragment, that includes all checks`}</Description>
...
```
          ...
          <DocBlock title="_testKeywordMaker" kind="lang" link="/docs/Stdlib/mexpr/keyword-maker.mc/lang-_testKeywordMaker">

```mc
lang _testKeywordMaker
```

<Description>{`A test fragment that is used to test the approach. This  
fragment can be used as a template when using the keyword maker.`}</Description>
