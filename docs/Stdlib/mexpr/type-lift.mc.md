...
<a href={"/docs/Stdlib/assoc-seq.mc"} style={S.link}>assoc-seq.mc</a>, <a href={"/docs/Stdlib/map.mc"} style={S.link}>map.mc</a>, <a href={"/docs/Stdlib/set.mc"} style={S.link}>set.mc</a>, <a href={"/docs/Stdlib/name.mc"} style={S.link}>name.mc</a>, <a href={"/docs/Stdlib/stringid.mc"} style={S.link}>stringid.mc</a>, <a href={"/docs/Stdlib/mexpr/ast.mc"} style={S.link}>ast.mc</a>, <a href={"/docs/Stdlib/mexpr/ast-builder.mc"} style={S.link}>ast-builder.mc</a>, <a href={"/docs/Stdlib/mexpr/pprint.mc"} style={S.link}>pprint.mc</a>, <a href={"/docs/Stdlib/mexpr/symbolize.mc"} style={S.link}>symbolize.mc</a>, <a href={"/docs/Stdlib/mexpr/type-check.mc"} style={S.link}>type-check.mc</a>, <a href={"/docs/Stdlib/mexpr/cmp.mc"} style={S.link}>cmp.mc</a>  
  
## Languages  
  

          <DocBlock title="VariantNameTypeAst" kind="lang" link="/docs/Stdlib/mexpr/type-lift.mc/lang-VariantNameTypeAst">

```mc
lang VariantNameTypeAst
```

<Description>{`This type is added specifically for the type lifting to allow distinguishing  
...
```
          ...
          <DocBlock title="TypeLiftBase" kind="lang" link="/docs/Stdlib/mexpr/type-lift.mc/lang-TypeLiftBase">
...
```
          ...
          <DocBlock title="TypeLiftAddSeqToEnv" kind="lang" link="/docs/Stdlib/mexpr/type-lift.mc/lang-TypeLiftAddSeqToEnv">

```mc
lang TypeLiftAddSeqToEnv
```

<Description>{`Define function for adding sequence types to environment`}</Description>
...
```
          ...
          <DocBlock title="TypeLiftAddTensorToEnv" kind="lang" link="/docs/Stdlib/mexpr/type-lift.mc/lang-TypeLiftAddTensorToEnv">

```mc
lang TypeLiftAddTensorToEnv
```
...
```
          ...
          <DocBlock title="TypeLift" kind="lang" link="/docs/Stdlib/mexpr/type-lift.mc/lang-TypeLift">
...
```
          ...
          <DocBlock title="TypeLiftAddRecordToEnv" kind="lang" link="/docs/Stdlib/mexpr/type-lift.mc/lang-TypeLiftAddRecordToEnv">

```mc
lang TypeLiftAddRecordToEnv
```
...
```
          ...
          <DocBlock title="TypeTypeLift" kind="lang" link="/docs/Stdlib/mexpr/type-lift.mc/lang-TypeTypeLift">
...
```
          ...
          <DocBlock title="DataTypeLift" kind="lang" link="/docs/Stdlib/mexpr/type-lift.mc/lang-DataTypeLift">
...
```
          ...
          <DocBlock title="MatchTypeLift" kind="lang" link="/docs/Stdlib/mexpr/type-lift.mc/lang-MatchTypeLift">
...
```
          ...
          <DocBlock title="RecordTypeTypeLift" kind="lang" link="/docs/Stdlib/mexpr/type-lift.mc/lang-RecordTypeTypeLift">

```mc
lang RecordTypeTypeLift
```
...
```
          ...
          <DocBlock title="SeqTypeTypeLift" kind="lang" link="/docs/Stdlib/mexpr/type-lift.mc/lang-SeqTypeTypeLift">

```mc
lang SeqTypeTypeLift
```

<Description>{`Optional lifting of sequences \(not added as default in MExprTypeLift\)`}</Description>
...
```
          ...
          <DocBlock title="SeqTypeNoStringTypeLift" kind="lang" link="/docs/Stdlib/mexpr/type-lift.mc/lang-SeqTypeNoStringTypeLift">

```mc
lang SeqTypeNoStringTypeLift
```

<Description>{`Type lifting, but leave strings = \[char\] intact \(not added as default in MExprTypeLift\).`}</Description>
...
```
          ...
          <DocBlock title="TensorTypeTypeLift" kind="lang" link="/docs/Stdlib/mexpr/type-lift.mc/lang-TensorTypeTypeLift">

```mc
lang TensorTypeTypeLift
```

<Description>{`Optional type lifting of tensors \(not added to MExprTypeLift by default\)`}</Description>
...
```
          ...
          <DocBlock title="AppTypeTypeLift" kind="lang" link="/docs/Stdlib/mexpr/type-lift.mc/lang-AppTypeTypeLift">

```mc
lang AppTypeTypeLift
```
...
```
          ...
          <DocBlock title="MExprTypeLift" kind="lang" link="/docs/Stdlib/mexpr/type-lift.mc/lang-MExprTypeLift">
...
```
          ...
          <DocBlock title="TestLang" kind="lang" link="/docs/Stdlib/mexpr/type-lift.mc/lang-TestLang">
