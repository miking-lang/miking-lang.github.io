...
<a href={"/docs/Stdlib/c/ast.mc"} style={S.link}>ast.mc</a>, <a href={"/docs/Stdlib/string.mc"} style={S.link}>string.mc</a>, <a href={"/docs/Stdlib/char.mc"} style={S.link}>char.mc</a>, <a href={"/docs/Stdlib/mexpr/pprint.mc"} style={S.link}>mexpr/pprint.mc</a>  
  
## Languages  
  

          <DocBlock title="CExprTypePrettyPrint" kind="lang" link="/docs/Stdlib/c/pprint.mc/lang-CExprTypePrettyPrint">

```mc
lang CExprTypePrettyPrint
```
...
```
          ...
          <DocBlock title="CInitPrettyPrint" kind="lang" link="/docs/Stdlib/c/pprint.mc/lang-CInitPrettyPrint">

```mc
lang CInitPrettyPrint
```
...
```
          ...
          <DocBlock title="CDefPrettyPrint" kind="lang" link="/docs/Stdlib/c/pprint.mc/lang-CDefPrettyPrint">

```mc
lang CDefPrettyPrint
```
...
```
          ...
          <DocBlock title="CStmtPrettyPrint" kind="lang" link="/docs/Stdlib/c/pprint.mc/lang-CStmtPrettyPrint">
...
```
          ...
          <DocBlock title="CTopPrettyPrint" kind="lang" link="/docs/Stdlib/c/pprint.mc/lang-CTopPrettyPrint">
...
```
          ...
          <DocBlock title="CPrettyPrint" kind="lang" link="/docs/Stdlib/c/pprint.mc/lang-CPrettyPrint">
...
```
          ...
          <DocBlock title="CProgPrettyPrint" kind="lang" link="/docs/Stdlib/c/pprint.mc/lang-CProgPrettyPrint">

```mc
lang CProgPrettyPrint
```
...
```
          ...
          <DocBlock title="Test" kind="lang" link="/docs/Stdlib/c/pprint.mc/lang-Test">
...
## Variables  
          ...
          <DocBlock title="_par" kind="let">

```mc
let _par str : String -> String
```

<Description>{`Surrounds a string with parentheses`}</Description>
...
```
          ...
          <DocBlock title="_joinSpace" kind="let">

```mc
let _joinSpace fst snd : String -> String -> String
```

<Description>{`Combines two strings with space in between \(if the second string is  
...
```
          ...
          <DocBlock title="replaceInvalidChar" kind="let">

```mc
let replaceInvalidChar c : Char -> Char
```

<Description>{`Replace invalid characters with underscore`}</Description>
...
```
          ...
          <DocBlock title="escapeIdentifier" kind="let">

```mc
let escapeIdentifier str : String -> String
```

<Description>{`Ensure string is a valid C identifier`}</Description>
...
```
          ...
          <DocBlock title="cPprintEnvGetStr" kind="let">

```mc
let cPprintEnvGetStr env id : PprintEnv -> Name -> (PprintEnv, String)
```
...
```
          ...
          <DocBlock title="cPprintEnvGetOptStr" kind="let">

```mc
let cPprintEnvGetOptStr env id : PprintEnv -> Option Name -> (PprintEnv, String)
```

<Description>{`Similar to cPprintEnvGetStr above, but takes an Option Name as  
argument. If it is None \(\), the returned string is "".`}</Description>
...
```
          ...
          <DocBlock title="cKeywords" kind="let">

```mc
let cKeywords  : [String]
```

<Description>{`From https://en.cppreference.com/w/c/keyword and  
https://en.cppreference.com/w/cpp/keyword`}</Description>
