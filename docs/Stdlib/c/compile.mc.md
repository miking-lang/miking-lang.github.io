...
<a href={"/docs/Stdlib/mexpr/ast.mc"} style={S.link}>mexpr/ast.mc</a>, <a href={"/docs/Stdlib/mexpr/ast-builder.mc"} style={S.link}>mexpr/ast-builder.mc</a>, <a href={"/docs/Stdlib/mexpr/anf.mc"} style={S.link}>mexpr/anf.mc</a>, <a href={"/docs/Stdlib/mexpr/symbolize.mc"} style={S.link}>mexpr/symbolize.mc</a>, <a href={"/docs/Stdlib/mexpr/type-check.mc"} style={S.link}>mexpr/type-check.mc</a>, <a href={"/docs/Stdlib/mexpr/remove-ascription.mc"} style={S.link}>mexpr/remove-ascription.mc</a>, <a href={"/docs/Stdlib/mexpr/type-lift.mc"} style={S.link}>mexpr/type-lift.mc</a>, <a href={"/docs/Stdlib/mexpr/record.mc"} style={S.link}>mexpr/record.mc</a>, <a href={"/docs/Stdlib/mexpr/builtin.mc"} style={S.link}>mexpr/builtin.mc</a>, <a href={"/docs/Stdlib/mexpr/boot-parser.mc"} style={S.link}>mexpr/boot-parser.mc</a>, <a href={"/docs/Stdlib/name.mc"} style={S.link}>name.mc</a>, <a href={"/docs/Stdlib/map.mc"} style={S.link}>map.mc</a>, <a href={"/docs/Stdlib/set.mc"} style={S.link}>set.mc</a>, <a href={"/docs/Stdlib/c/ast.mc"} style={S.link}>ast.mc</a>, <a href={"/docs/Stdlib/c/pprint.mc"} style={S.link}>pprint.mc</a>, <a href={"/docs/Stdlib/ext/math-ext.ext-c.mc"} style={S.link}>ext/math-ext.ext-c.mc</a>  
  
## Types  
  

          <DocBlock title="CompileCOptions" kind="type">

```mc
type CompileCOptions : { tensorMaxRank: Int, use32BitInts: Bool, use32BitFloats: Bool }
```

<Description>{`TODO\(dlunde,2022\-04\-29\): A bug in the MLang transformation currently  
prevents this fragment from being put in MExprCCompileBase`}</Description>
...
## Languages  
          ...
          <DocBlock title="MExprCCompileBase" kind="lang" link="/docs/Stdlib/c/compile.mc/lang-MExprCCompileBase">

```mc
lang MExprCCompileBase
```
...
```
          ...
          <DocBlock title="MExprTensorCCompile" kind="lang" link="/docs/Stdlib/c/compile.mc/lang-MExprTensorCCompile">

```mc
lang MExprTensorCCompile
```

<Description>{`Generation of tensor function for computing the linear index given a  
...
```
          ...
          <DocBlock title="MExprCCompile" kind="lang" link="/docs/Stdlib/c/compile.mc/lang-MExprCCompile">
...
```
          ...
          <DocBlock title="MExprCCompileAlloc" kind="lang" link="/docs/Stdlib/c/compile.mc/lang-MExprCCompileAlloc">

```mc
lang MExprCCompileAlloc
```
...
```
          ...
          <DocBlock title="MExprCCompileGCC" kind="lang" link="/docs/Stdlib/c/compile.mc/lang-MExprCCompileGCC">
...
```
          ...
          <DocBlock title="Test" kind="lang" link="/docs/Stdlib/c/compile.mc/lang-Test">
...
```
          ...
          <DocBlock title="_unwrapType" kind="let">

```mc
let _unwrapType tyEnv ty : AssocSeq Name Ast_Type -> Ast_Type -> Ast_Type
```
...
```
          ...
          <DocBlock title="_lookupTypeName" kind="let">

```mc
let _lookupTypeName tyEnv ty : AssocSeq Name Ast_Type -> Ast_Type -> Name
```

<Description>{`Look up the name of a type variable corresponding to a given concrete type`}</Description>
...
```mc
let _assign lhs rhs : CExprTypeAst_CExpr -> CExprTypeAst_CExpr -> CExprTypeAst_CExpr
```

<Description>{`C assignment shorthand`}</Description>
...
```
          ...
          <DocBlock title="externalsMap" kind="let">

```mc
let externalsMap  : ExtMap
```

<Description>{`Collect all maps of externals. Should be done automatically at some point,  
but for now these files must be manually included and added to this map.`}</Description>
...
```
          ...
          <DocBlock title="externalNames" kind="let">

```mc
let externalNames  : [Name]
```

<Description>{`Retrieve names used for externals. Used for making sure these names are printed without modification during C code generation.`}</Description>
...
```
          ...
          <DocBlock title="externalIncludes" kind="let">

```mc
let externalIncludes  : [String]
```

<Description>{`Collect all includes for C externals.`}</Description>
...
```
          ...
          <DocBlock title="cIncludes" kind="let">

```mc
let cIncludes  : [String]
```

<Description>{`Customizable set of includes`}</Description>
...
```
          ...
          <DocBlock title="_printf" kind="let">

```mc
let _printf  : Name
```

<Description>{`Names used in the compiler for intrinsics`}</Description>
...
```
          ...
          <DocBlock title="_cartesianToLinearIndex" kind="let">

```mc
let _cartesianToLinearIndex  : Name
```
...
```
          ...
          <DocBlock title="_tensorShape" kind="let">

```mc
let _tensorShape  : Name
```
...
```
          ...
          <DocBlock title="cCompilerNames" kind="let">

```mc
let cCompilerNames  : [Name]
```

<Description>{`C names that must be pretty printed using their exact string`}</Description>
...
```
          ...
          <DocBlock title="_constrKey" kind="let">

```mc
let _constrKey  : Name
```

<Description>{`Various names used when defining C structs`}</Description>
...
```
          ...
          <DocBlock title="_seqKey" kind="let">
...
```
          ...
          <DocBlock title="_seqLenKey" kind="let">
...
```
          ...
          <DocBlock title="_tensorIdKey" kind="let">

```mc
let _tensorIdKey  : Name
```
...
```
          ...
          <DocBlock title="_tensorDataKey" kind="let">

```mc
let _tensorDataKey  : Name
```
...
```
          ...
          <DocBlock title="_tensorDimsKey" kind="let">

```mc
let _tensorDimsKey  : Name
```
...
```
          ...
          <DocBlock title="_tensorRankKey" kind="let">

```mc
let _tensorRankKey  : Name
```
...
```
          ...
          <DocBlock title="_tensorSizeKey" kind="let">

```mc
let _tensorSizeKey  : Name
```
...
```
          ...
          <DocBlock title="cGccCompilerNames" kind="let">

```mc
let cGccCompilerNames  : [Name]
```
...
```
          ...
          <DocBlock title="compileGCC" kind="let">

```mc
let compileGCC typeEnv opts prog : [(Name, Ast_Type)] -> CompileCOptions -> Ast_Expr -> CProgAst_CProg
```
...
```
          ...
          <DocBlock title="printCompiledCProg" kind="let">

```mc
let printCompiledCProg cprog : CProgAst_CProg -> String
```
