...
<a href={"/docs/Stdlib/bool.mc"} style={S.link}>bool.mc</a>, <a href={"/docs/Stdlib/error.mc"} style={S.link}>error.mc</a>, <a href={"/docs/Stdlib/map.mc"} style={S.link}>map.mc</a>, <a href={"/docs/Stdlib/name.mc"} style={S.link}>name.mc</a>, <a href={"/docs/Stdlib/set.mc"} style={S.link}>set.mc</a>, <a href={"/docs/Stdlib/mlang/pprint.mc"} style={S.link}>pprint.mc</a>, <a href={"/docs/Stdlib/mlang/ast.mc"} style={S.link}>ast.mc</a>, <a href={"/docs/Stdlib/mlang/language-composer.mc"} style={S.link}>language-composer.mc</a>, <a href={"/docs/Stdlib/mexpr/symbolize.mc"} style={S.link}>mexpr/symbolize.mc</a>, <a href={"/docs/Stdlib/mexpr/ast-builder.mc"} style={S.link}>mexpr/ast-builder.mc</a>  
  
## Languages  
  

          <DocBlock title="DeclUseSym" kind="lang" link="/docs/Stdlib/mlang/symbolize.mc/lang-DeclUseSym">
...
```
          ...
          <DocBlock title="TyUseSym" kind="lang" link="/docs/Stdlib/mlang/symbolize.mc/lang-TyUseSym">
...
```
          ...
          <DocBlock title="DeclSym" kind="lang" link="/docs/Stdlib/mlang/symbolize.mc/lang-DeclSym">
...
```
          ...
          <DocBlock title="DeclSynSym" kind="lang" link="/docs/Stdlib/mlang/symbolize.mc/lang-DeclSynSym">
...
```
          ...
          <DocBlock title="DeclSemSym" kind="lang" link="/docs/Stdlib/mlang/symbolize.mc/lang-DeclSemSym">
...
```
          ...
          <DocBlock title="InnerDeclTypeSym" kind="lang" link="/docs/Stdlib/mlang/symbolize.mc/lang-InnerDeclTypeSym">

```mc
lang InnerDeclTypeSym
```
...
```
          ...
          <DocBlock title="DeclMLangLangSym" kind="lang" link="/docs/Stdlib/mlang/symbolize.mc/lang-DeclMLangLangSym">

```mc
lang DeclMLangLangSym
```
...
```
          ...
          <DocBlock title="MLangProgramSym" kind="lang" link="/docs/Stdlib/mlang/symbolize.mc/lang-MLangProgramSym">

```mc
lang MLangProgramSym
```
...
```
          ...
          <DocBlock title="MLangSymWihoutLang" kind="lang" link="/docs/Stdlib/mlang/symbolize.mc/lang-MLangSymWihoutLang">

```mc
lang MLangSymWihoutLang
```
...
```
          ...
          <DocBlock title="MLangSym" kind="lang" link="/docs/Stdlib/mlang/symbolize.mc/lang-MLangSym">
...
```
          ...
          <DocBlock title="TestLangWithoutLang" kind="lang" link="/docs/Stdlib/mlang/symbolize.mc/lang-TestLangWithoutLang">

```mc
lang TestLangWithoutLang
```
...
```
          ...
          <DocBlock title="TestLang" kind="lang" link="/docs/Stdlib/mlang/symbolize.mc/lang-TestLang">
...
```
          ...
          <DocBlock title="sem2ident" kind="let">

```mc
let sem2ident d : Ast_Decl -> Name
```
...
```
          ...
          <DocBlock title="syn2ident" kind="let">

```mc
let syn2ident d : Ast_Decl -> Name
```
...
```
          ...
          <DocBlock title="type2ident" kind="let">

```mc
let type2ident d : Ast_Decl -> Name
```
...
```
          ...
          <DocBlock title="name2pair" kind="let">

```mc
let name2pair n : Name -> (String, Name)
```
...
```
          ...
          <DocBlock title="updateEnv" kind="let">

```mc
let updateEnv symEnv langEnv : SymEnv -> NameEnv -> SymEnv
```
...
```
          ...
          <DocBlock title="synDeclIdentHasSymbolized" kind="let">

```mc
let synDeclIdentHasSymbolized decl : Ast_Decl -> ()
```
...
```
          ...
          <DocBlock title="typeDeclIdentHasSymbolized" kind="let">

```mc
let typeDeclIdentHasSymbolized decl : Ast_Decl -> ()
```
...
```
          ...
          <DocBlock title="semDeclIdentHasSymbolized" kind="let">

```mc
let semDeclIdentHasSymbolized decl : Ast_Decl -> ()
```
