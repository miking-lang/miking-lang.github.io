...
<a href={"/docs/Stdlib/pmexpr/pattern-match.mc"} style={S.link}>pmexpr/pattern-match.mc</a>, <a href={"/docs/Stdlib/pmexpr/parallel-patterns.mc"} style={S.link}>pmexpr/parallel-patterns.mc</a>, <a href={"/docs/Stdlib/pmexpr/promote.mc"} style={S.link}>pmexpr/promote.mc</a>  
  
## Languages  
  

          <DocBlock title="PMExprParallelPattern" kind="lang" link="/docs/Stdlib/pmexpr/parallel-rewrite.mc/lang-PMExprParallelPattern">

```mc
lang PMExprParallelPattern
```
...
```
          ...
          <DocBlock title="TestLang" kind="lang" link="/docs/Stdlib/pmexpr/parallel-rewrite.mc/lang-TestLang">
