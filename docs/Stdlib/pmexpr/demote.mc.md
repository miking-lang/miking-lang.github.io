...
<a href={"/docs/Stdlib/mexpr/ast-builder.mc"} style={S.link}>mexpr/ast-builder.mc</a>, <a href={"/docs/Stdlib/pmexpr/ast.mc"} style={S.link}>pmexpr/ast.mc</a>, <a href={"/docs/Stdlib/pmexpr/pprint.mc"} style={S.link}>pmexpr/pprint.mc</a>  
  
## Languages  
  

          <DocBlock title="PMExprDemoteBase" kind="lang" link="/docs/Stdlib/pmexpr/demote.mc/lang-PMExprDemoteBase">

```mc
lang PMExprDemoteBase
```
...
```
          ...
          <DocBlock title="PMExprDemoteAccelerate" kind="lang" link="/docs/Stdlib/pmexpr/demote.mc/lang-PMExprDemoteAccelerate">

```mc
lang PMExprDemoteAccelerate
```
...
```
          ...
          <DocBlock title="PMExprDemoteFlatten" kind="lang" link="/docs/Stdlib/pmexpr/demote.mc/lang-PMExprDemoteFlatten">

```mc
lang PMExprDemoteFlatten
```
...
```
          ...
          <DocBlock title="PMExprDemoteMap2" kind="lang" link="/docs/Stdlib/pmexpr/demote.mc/lang-PMExprDemoteMap2">

```mc
lang PMExprDemoteMap2
```
...
```
          ...
          <DocBlock title="PMExprDemoteReduce" kind="lang" link="/docs/Stdlib/pmexpr/demote.mc/lang-PMExprDemoteReduce">

```mc
lang PMExprDemoteReduce
```
...
```
          ...
          <DocBlock title="PMExprDemoteLoop" kind="lang" link="/docs/Stdlib/pmexpr/demote.mc/lang-PMExprDemoteLoop">

```mc
lang PMExprDemoteLoop
```
...
```
          ...
          <DocBlock title="PMExprDemotePrintFloat" kind="lang" link="/docs/Stdlib/pmexpr/demote.mc/lang-PMExprDemotePrintFloat">

```mc
lang PMExprDemotePrintFloat
```
...
```
          ...
          <DocBlock title="PMExprDemote" kind="lang" link="/docs/Stdlib/pmexpr/demote.mc/lang-PMExprDemote">
