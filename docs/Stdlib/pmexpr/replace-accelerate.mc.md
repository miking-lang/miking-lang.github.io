...
<a href={"/docs/Stdlib/mexpr/record.mc"} style={S.link}>mexpr/record.mc</a>, <a href={"/docs/Stdlib/mexpr/type-lift.mc"} style={S.link}>mexpr/type-lift.mc</a>, <a href={"/docs/Stdlib/ocaml/ast.mc"} style={S.link}>ocaml/ast.mc</a>, <a href={"/docs/Stdlib/ocaml/external.mc"} style={S.link}>ocaml/external.mc</a>, <a href={"/docs/Stdlib/ocaml/generate.mc"} style={S.link}>ocaml/generate.mc</a>, <a href={"/docs/Stdlib/ocaml/pprint.mc"} style={S.link}>ocaml/pprint.mc</a>, <a href={"/docs/Stdlib/pmexpr/ast.mc"} style={S.link}>pmexpr/ast.mc</a>, <a href={"/docs/Stdlib/pmexpr/extract.mc"} style={S.link}>pmexpr/extract.mc</a>, <a href={"/docs/Stdlib/pmexpr/utils.mc"} style={S.link}>pmexpr/utils.mc</a>  
  
## Languages  
  

          <DocBlock title="PMExprReplaceAccelerate" kind="lang" link="/docs/Stdlib/pmexpr/replace-accelerate.mc/lang-PMExprReplaceAccelerate">
