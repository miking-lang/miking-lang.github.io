...
<a href={"/docs/Stdlib/pmexpr/ast.mc"} style={S.link}>pmexpr/ast.mc</a>, <a href={"/docs/Stdlib/pmexpr/utils.mc"} style={S.link}>pmexpr/utils.mc</a>  
  
## Languages  
  

          <DocBlock title="PMExprInlineFunctions" kind="lang" link="/docs/Stdlib/pmexpr/inline-higher-order.mc/lang-PMExprInlineFunctions">

```mc
lang PMExprInlineFunctions
```
