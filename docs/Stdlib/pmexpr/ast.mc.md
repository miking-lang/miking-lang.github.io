...
<a href={"/docs/Stdlib/mexpr/anf.mc"} style={S.link}>mexpr/anf.mc</a>, <a href={"/docs/Stdlib/mexpr/ast.mc"} style={S.link}>mexpr/ast.mc</a>, <a href={"/docs/Stdlib/mexpr/eq.mc"} style={S.link}>mexpr/eq.mc</a>, <a href={"/docs/Stdlib/mexpr/keyword-maker.mc"} style={S.link}>mexpr/keyword-maker.mc</a>, <a href={"/docs/Stdlib/mexpr/pprint.mc"} style={S.link}>mexpr/pprint.mc</a>, <a href={"/docs/Stdlib/mexpr/type-check.mc"} style={S.link}>mexpr/type-check.mc</a>  
  
## Languages  
  

          <DocBlock title="PMExprAst" kind="lang" link="/docs/Stdlib/pmexpr/ast.mc/lang-PMExprAst">
...
## Variables  
          ...
          <DocBlock title="accelerate_" kind="let">

```mc
let accelerate_ e : Ast_Expr -> Ast_Expr
```
...
```
          ...
          <DocBlock title="flatten_" kind="let">

```mc
let flatten_ e : Ast_Expr -> Ast_Expr
```
...
```
          ...
          <DocBlock title="map2_" kind="let">

```mc
let map2_ f as bs : Ast_Expr -> Ast_Expr -> Ast_Expr -> Ast_Expr
```
...
```
          ...
          <DocBlock title="parallelReduce_" kind="let">

```mc
let parallelReduce_ f ne as : Ast_Expr -> Ast_Expr -> Ast_Expr -> Ast_Expr
```
...
```
          ...
          <DocBlock title="loop_" kind="let">

```mc
let loop_ n f : Ast_Expr -> Ast_Expr -> Ast_Expr
```
...
```
          ...
          <DocBlock title="loopAcc_" kind="let">

```mc
let loopAcc_ ne n f : Ast_Expr -> Ast_Expr -> Ast_Expr -> Ast_Expr
```
...
```
          ...
          <DocBlock title="parallelLoop_" kind="let">

```mc
let parallelLoop_ n f : Ast_Expr -> Ast_Expr -> Ast_Expr
```
...
```
          ...
          <DocBlock title="parallelSizeCoercion_" kind="let">

```mc
let parallelSizeCoercion_ e size : Ast_Expr -> Name -> Ast_Expr
```
...
```
          ...
          <DocBlock title="parallelSizeEquality_" kind="let">

```mc
let parallelSizeEquality_ x1 d1 x2 d2 : Name -> Int -> Name -> Int -> Ast_Expr
```
...
```
          ...
          <DocBlock title="printFloat_" kind="let">

```mc
let printFloat_ e : Ast_Expr -> Ast_Expr
```
