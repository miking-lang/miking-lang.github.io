...
<a href={"/docs/Stdlib/cuda/ast.mc"} style={S.link}>cuda/ast.mc</a>, <a href={"/docs/Stdlib/cuda/compile.mc"} style={S.link}>cuda/compile.mc</a>, <a href={"/docs/Stdlib/mexpr/ast.mc"} style={S.link}>mexpr/ast.mc</a>, <a href={"/docs/Stdlib/mexpr/cmp.mc"} style={S.link}>mexpr/cmp.mc</a>, <a href={"/docs/Stdlib/mexpr/record.mc"} style={S.link}>mexpr/record.mc</a>, <a href={"/docs/Stdlib/pmexpr/wrapper.mc"} style={S.link}>pmexpr/wrapper.mc</a>  
  
## Languages  
  

          <DocBlock title="CudaCWrapperBase" kind="lang" link="/docs/Stdlib/cuda/wrapper.mc/lang-CudaCWrapperBase">

```mc
lang CudaCWrapperBase
```
...
```
          ...
          <DocBlock title="CudaTensorWrapper" kind="lang" link="/docs/Stdlib/cuda/wrapper.mc/lang-CudaTensorWrapper">

```mc
lang CudaTensorWrapper
```
...
```
          ...
          <DocBlock title="OCamlToCudaWrapper" kind="lang" link="/docs/Stdlib/cuda/wrapper.mc/lang-OCamlToCudaWrapper">

```mc
lang OCamlToCudaWrapper
```
...
```
          ...
          <DocBlock title="CudaCallWrapper" kind="lang" link="/docs/Stdlib/cuda/wrapper.mc/lang-CudaCallWrapper">

```mc
lang CudaCallWrapper
```
...
```
          ...
          <DocBlock title="CudaToOCamlWrapper" kind="lang" link="/docs/Stdlib/cuda/wrapper.mc/lang-CudaToOCamlWrapper">

```mc
lang CudaToOCamlWrapper
```
...
```
          ...
          <DocBlock title="CudaCWrapper" kind="lang" link="/docs/Stdlib/cuda/wrapper.mc/lang-CudaCWrapper">
...
## Variables  
          ...
          <DocBlock title="_tensorIntervalTypeId" kind="let">

```mc
let _tensorIntervalTypeId  : Name
```
...
```
          ...
          <DocBlock title="_tensorIntervalId" kind="let">

```mc
let _tensorIntervalId  : Name
```
...
```
          ...
          <DocBlock title="_tensorIntervalBegin" kind="let">

```mc
let _tensorIntervalBegin  : Name
```
...
```
          ...
          <DocBlock title="_tensorIntervalEnd" kind="let">

```mc
let _tensorIntervalEnd  : Name
```
...
```
          ...
          <DocBlock title="_tensorIntervalRank" kind="let">

```mc
let _tensorIntervalRank  : Name
```
...
```
          ...
          <DocBlock title="_tensorIntervalDims" kind="let">

```mc
let _tensorIntervalDims  : Name
```
...
```
          ...
          <DocBlock title="_tensorIntervalNext" kind="let">

```mc
let _tensorIntervalNext  : Name
```
...
```
          ...
          <DocBlock title="_tensorIntervalOmitCopyTo" kind="let">

```mc
let _tensorIntervalOmitCopyTo  : Name
```
...
```
          ...
          <DocBlock title="_tensorIntervalOmitCopyFrom" kind="let">

```mc
let _tensorIntervalOmitCopyFrom  : Name
```
...
```
          ...
          <DocBlock title="_tensorIntervalCudaElemType" kind="let">

```mc
let _tensorIntervalCudaElemType  : Name
```
...
```
          ...
          <DocBlock title="_topTensorTypeId" kind="let">

```mc
let _topTensorTypeId  : Name
```
...
```
          ...
          <DocBlock title="_topTensorId" kind="let">

```mc
let _topTensorId  : Name
```
...
```
          ...
          <DocBlock title="_topTensorOCaml" kind="let">

```mc
let _topTensorOCaml  : Name
```
...
```
          ...
          <DocBlock title="_topTensorCuda" kind="let">

```mc
let _topTensorCuda  : Name
```
...
```
          ...
          <DocBlock title="_topTensorSize" kind="let">

```mc
let _topTensorSize  : Name
```
...
```
          ...
          <DocBlock title="_topTensorPred" kind="let">

```mc
let _topTensorPred  : Name
```
...
```
          ...
          <DocBlock title="_topTensorOmitCopyTo" kind="let">

```mc
let _topTensorOmitCopyTo  : Name
```
...
```
          ...
          <DocBlock title="_topTensorOmitCopyFrom" kind="let">

```mc
let _topTensorOmitCopyFrom  : Name
```
...
```
          ...
          <DocBlock title="_topTensorCudaElemType" kind="let">

```mc
let _topTensorCudaElemType  : Name
```
...
```
          ...
          <DocBlock title="_tensorHeadId" kind="let">

```mc
let _tensorHeadId  : Name
```
...
```
          ...
          <DocBlock title="_tensorStartId" kind="let">

```mc
let _tensorStartId  : Name
```
...
```
          ...
          <DocBlock title="_tensorCountId" kind="let">

```mc
let _tensorCountId  : Name
```
...
```
          ...
          <DocBlock title="_tensorIntervalsId" kind="let">

```mc
let _tensorIntervalsId  : Name
```
...
```
          ...
          <DocBlock title="_tensorTopMapId" kind="let">

```mc
let _tensorTopMapId  : Name
```
...
```
          ...
          <DocBlock title="_tensorNmainId" kind="let">

```mc
let _tensorNmainId  : Name
```
...
```
          ...
          <DocBlock title="_tensorTopsId" kind="let">

```mc
let _tensorTopsId  : Name
```
...
```
          ...
          <DocBlock title="_intervalCmpBegin" kind="let">

```mc
let _intervalCmpBegin  : Name
```
...
```
          ...
          <DocBlock title="_intervalCmpId" kind="let">

```mc
let _intervalCmpId  : Name
```
...
```
          ...
          <DocBlock title="_cudaErrorCheckStmt" kind="let">

```mc
let _cudaErrorCheckStmt  : CStmtAst_CStmt
```
