...
<a href={"/docs/Stdlib/cuda/pmexpr-ast.mc"} style={S.link}>cuda/pmexpr-ast.mc</a>, <a href={"/docs/Stdlib/cuda/intrinsics/intrinsic.mc"} style={S.link}>cuda/intrinsics/intrinsic.mc</a>  
  
## Languages  
  

          <DocBlock title="CudaLoopKernelIntrinsic" kind="lang" link="/docs/Stdlib/cuda/intrinsics/loop-kernel.mc/lang-CudaLoopKernelIntrinsic">

```mc
lang CudaLoopKernelIntrinsic
```
