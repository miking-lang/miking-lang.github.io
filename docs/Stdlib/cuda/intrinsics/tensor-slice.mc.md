...
## Languages  
          ...
          <DocBlock title="CudaTensorSliceIntrinsic" kind="lang" link="/docs/Stdlib/cuda/intrinsics/tensor-slice.mc/lang-CudaTensorSliceIntrinsic">

```mc
lang CudaTensorSliceIntrinsic
```
