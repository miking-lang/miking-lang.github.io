...
## Semantics  
          ...
          <DocBlock title="generateCudaIntrinsicCallNoRet" kind="sem">

```mc
sem generateCudaIntrinsicCallNoRet : MExprCCompileBase_CompileCEnv -> [CudaAst_CuTop] -> CExprTypeAst_CExpr -> ([CudaAst_CuTop], CStmtAst_CStmt)
```
