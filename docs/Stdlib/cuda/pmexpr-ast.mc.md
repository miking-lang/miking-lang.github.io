...
<a href={"/docs/Stdlib/name.mc"} style={S.link}>name.mc</a>, <a href={"/docs/Stdlib/pmexpr/ast.mc"} style={S.link}>pmexpr/ast.mc</a>  
  
## Languages  
  

          <DocBlock title="CudaPMExprAst" kind="lang" link="/docs/Stdlib/cuda/pmexpr-ast.mc/lang-CudaPMExprAst">
...
## Variables  
          ...
          <DocBlock title="seqMap_" kind="let">

```mc
let seqMap_ f s : Ast_Expr -> Ast_Expr -> Ast_Expr
```
...
```
          ...
          <DocBlock title="seqFoldl_" kind="let">

```mc
let seqFoldl_ f acc s : Ast_Expr -> Ast_Expr -> Ast_Expr -> Ast_Expr
```
...
```mc
let tensorSliceExn_ t slice : Ast_Expr -> Ast_Expr -> Ast_Expr
```
...
```mc
let tensorSubExn_ t ofs len : Ast_Expr -> Ast_Expr -> Ast_Expr -> Ast_Expr
```
...
```
          ...
          <DocBlock title="mapKernel_" kind="let">

```mc
let mapKernel_ f s : Ast_Expr -> Ast_Expr -> Ast_Expr
```
...
```
          ...
          <DocBlock title="reduceKernel_" kind="let">

```mc
let reduceKernel_ f ne s : Ast_Expr -> Ast_Expr -> Ast_Expr -> Ast_Expr
```
...
```
          ...
          <DocBlock title="loopKernel_" kind="let">

```mc
let loopKernel_ n f : Ast_Expr -> Ast_Expr -> Ast_Expr
```
