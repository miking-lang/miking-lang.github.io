...
<a href={"/docs/Stdlib/cp/ast.mc"} style={S.link}>ast.mc</a>, <a href={"/docs/Stdlib/cp/pprint.mc"} style={S.link}>pprint.mc</a>, <a href={"/docs/Stdlib/sys.mc"} style={S.link}>sys.mc</a>, <a href={"/docs/Stdlib/json.mc"} style={S.link}>json.mc</a>  
  
## Languages  
  

          <DocBlock title="COPSolve" kind="lang" link="/docs/Stdlib/cp/solve.mc/lang-COPSolve">
