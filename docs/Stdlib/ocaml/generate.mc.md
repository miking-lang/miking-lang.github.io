...
<a href={"/docs/Stdlib/mexpr/ast.mc"} style={S.link}>mexpr/ast.mc</a>, <a href={"/docs/Stdlib/mexpr/ast-builder.mc"} style={S.link}>mexpr/ast-builder.mc</a>, <a href={"/docs/Stdlib/mexpr/builtin.mc"} style={S.link}>mexpr/builtin.mc</a>, <a href={"/docs/Stdlib/mexpr/eq.mc"} style={S.link}>mexpr/eq.mc</a>, <a href={"/docs/Stdlib/mexpr/info.mc"} style={S.link}>mexpr/info.mc</a>, <a href={"/docs/Stdlib/mexpr/parser.mc"} style={S.link}>mexpr/parser.mc</a>, <a href={"/docs/Stdlib/mexpr/symbolize.mc"} style={S.link}>mexpr/symbolize.mc</a>, <a href={"/docs/Stdlib/mexpr/remove-ascription.mc"} style={S.link}>mexpr/remove-ascription.mc</a>, <a href={"/docs/Stdlib/mexpr/type-lift.mc"} style={S.link}>mexpr/type-lift.mc</a>, <a href={"/docs/Stdlib/mexpr/cmp.mc"} style={S.link}>mexpr/cmp.mc</a>, <a href={"/docs/Stdlib/mexpr/type.mc"} style={S.link}>mexpr/type.mc</a>, <a href={"/docs/Stdlib/ocaml/ast.mc"} style={S.link}>ocaml/ast.mc</a>, <a href={"/docs/Stdlib/ocaml/pprint.mc"} style={S.link}>ocaml/pprint.mc</a>, <a href={"/docs/Stdlib/ocaml/compile.mc"} style={S.link}>ocaml/compile.mc</a>, <a href={"/docs/Stdlib/ocaml/intrinsics-ops.mc"} style={S.link}>ocaml/intrinsics-ops.mc</a>, <a href={"/docs/Stdlib/ocaml/generate-env.mc"} style={S.link}>ocaml/generate-env.mc</a>, <a href={"/docs/Stdlib/ocaml/external.mc"} style={S.link}>ocaml/external.mc</a>, <a href={"/docs/Stdlib/common.mc"} style={S.link}>common.mc</a>  
  
## Types  
  

          <DocBlock title="MatchRecord" kind="type">

```mc
type MatchRecord : { target: Expr, pat: Pat, thn: Expr, els: Expr, ty: Type, info: Info }
```
...
## Languages  
          ...
          <DocBlock title="OCamlTopGenerate" kind="lang" link="/docs/Stdlib/ocaml/generate.mc/lang-OCamlTopGenerate">

```mc
lang OCamlTopGenerate
```
...
```
          ...
          <DocBlock title="OCamlMatchGenerate" kind="lang" link="/docs/Stdlib/ocaml/generate.mc/lang-OCamlMatchGenerate">

```mc
lang OCamlMatchGenerate
```

<Description>{`NOTE\(larshum, 2022\-12\-21\): This language fragment defines the compilation of  
...
AND, OR, and NOT patterns as well as nested patterns.`}</Description>
...
```
          ...
          <DocBlock title="OCamlGenerate" kind="lang" link="/docs/Stdlib/ocaml/generate.mc/lang-OCamlGenerate">
...
```
          ...
          <DocBlock title="OCamlTypeDeclGenerate" kind="lang" link="/docs/Stdlib/ocaml/generate.mc/lang-OCamlTypeDeclGenerate">

```mc
lang OCamlTypeDeclGenerate
```
...
## Variables  
          ...
          <DocBlock title="_omatch_" kind="let">

```mc
let _omatch_ target arms : Ast_Expr -> [(Ast_Pat, Ast_Expr)] -> Ast_Expr
```
...
```
          ...
          <DocBlock title="_if" kind="let">

```mc
let _if cond thn els : Ast_Expr -> Ast_Expr -> Ast_Expr -> Ast_Expr
```
...
```
          ...
          <DocBlock title="_isLengthAtLeastName" kind="let">

```mc
let _isLengthAtLeastName  : String
```
...
```
          ...
          <DocBlock title="_isLengthAtLeast" kind="let">

```mc
let _isLengthAtLeast  : Ast_Expr -> Ast_Expr -> Ast_Expr
```
...
```
          ...
          <DocBlock title="_builtinNameMap" kind="let">
...
```
          ...
          <DocBlock title="_builtinNamesSet" kind="let">
...
```
          ...
          <DocBlock title="_intrinsicName" kind="let">

```mc
let _intrinsicName str : String -> Name
```
...
```
          ...
          <DocBlock title="lookupRecordFields" kind="let">

```mc
let lookupRecordFields ty constrs : Ast_Type -> Map Name Ast_Type -> Option (Map SID Ast_Type)
```
...
```
          ...
          <DocBlock title="_makeTypeDeclarations" kind="let">

```mc
let _makeTypeDeclarations typeLiftEnvMap typeLiftEnv : all a. a -> AssocSeq Name Ast_Type -> ([OCamlTopAst_Top], Map (Map SID Ast_Type) Name)
```
...
```
          ...
          <DocBlock title="_typeLiftEnvToGenerateEnv" kind="let">

```mc
let _typeLiftEnvToGenerateEnv typeLiftEnvMap typeLiftEnv recordFieldsToName : all a. a -> AssocSeq Name Ast_Type -> Map (Map SID Ast_Type) Name -> GenerateEnv
```
