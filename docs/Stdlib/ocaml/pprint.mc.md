...
<a href={"/docs/Stdlib/ocaml/ast.mc"} style={S.link}>ocaml/ast.mc</a>, <a href={"/docs/Stdlib/mexpr/ast-builder.mc"} style={S.link}>mexpr/ast-builder.mc</a>, <a href={"/docs/Stdlib/ocaml/symbolize.mc"} style={S.link}>ocaml/symbolize.mc</a>, <a href={"/docs/Stdlib/mexpr/pprint.mc"} style={S.link}>mexpr/pprint.mc</a>, <a href={"/docs/Stdlib/mexpr/record.mc"} style={S.link}>mexpr/record.mc</a>, <a href={"/docs/Stdlib/char.mc"} style={S.link}>char.mc</a>, <a href={"/docs/Stdlib/name.mc"} style={S.link}>name.mc</a>, <a href={"/docs/Stdlib/ocaml/intrinsics-ops.mc"} style={S.link}>intrinsics-ops.mc</a>  
  
## Languages  
  

          <DocBlock title="OCamlTypePrettyPrint" kind="lang" link="/docs/Stdlib/ocaml/pprint.mc/lang-OCamlTypePrettyPrint">

```mc
lang OCamlTypePrettyPrint
```

<Description>{`Pretty\-printing of MExpr types in OCaml. Due to the obj\-wrapping, we do not  
...
will be printed as Obj.t.`}</Description>
...
```
          ...
          <DocBlock title="OCamlPrettyPrint" kind="lang" link="/docs/Stdlib/ocaml/pprint.mc/lang-OCamlPrettyPrint">
...
```
          ...
          <DocBlock title="TestLang" kind="lang" link="/docs/Stdlib/ocaml/pprint.mc/lang-TestLang">
...
## Variables  
          ...
          <DocBlock title="_isValidChar" kind="let">

```mc
let _isValidChar c : Char -> Bool
```
...
```
          ...
          <DocBlock title="_escapeChar" kind="let">

```mc
let _escapeChar c : Char -> Char
```
...
```
          ...
          <DocBlock title="escapeVarString" kind="let">

```mc
let escapeVarString s : String -> String
```
...
```
          ...
          <DocBlock title="escapeConString" kind="let">

```mc
let escapeConString s : String -> String
```
...
```
          ...
          <DocBlock title="escapeLabelString" kind="let">

```mc
let escapeLabelString s : String -> String
```
...
```
          ...
          <DocBlock title="escapeName" kind="let">

```mc
let escapeName n : (String, Symbol) -> (String, Symbol)
```
...
```
          ...
          <DocBlock title="escapeConName" kind="let">

```mc
let escapeConName n : (String, Symbol) -> (String, Symbol)
```
...
```
          ...
          <DocBlock title="noSymVarPrefix" kind="let">

```mc
let noSymVarPrefix  : String
```

<Description>{`Prefix of non\-symbolized identifiers, to avoid collision with symbolized  
...
```
          ...
          <DocBlock title="noSymConPrefix" kind="let">

```mc
let noSymConPrefix  : String
```
