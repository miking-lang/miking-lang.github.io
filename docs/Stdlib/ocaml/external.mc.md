...
<a href={"/docs/Stdlib/mexpr/type.mc"} style={S.link}>mexpr/type.mc</a>, <a href={"/docs/Stdlib/mexpr/record.mc"} style={S.link}>mexpr/record.mc</a>, <a href={"/docs/Stdlib/stringid.mc"} style={S.link}>stringid.mc</a>, <a href={"/docs/Stdlib/ocaml/external-includes.mc"} style={S.link}>ocaml/external-includes.mc</a>, <a href={"/docs/Stdlib/ocaml/ast.mc"} style={S.link}>ocaml/ast.mc</a>, <a href={"/docs/Stdlib/ocaml/intrinsics-ops.mc"} style={S.link}>ocaml/intrinsics-ops.mc</a>, <a href={"/docs/Stdlib/ocaml/generate-env.mc"} style={S.link}>ocaml/generate-env.mc</a>  
  
## Languages  
  

          <DocBlock title="OCamlChooseExternalImpl" kind="lang" link="/docs/Stdlib/ocaml/external.mc/lang-OCamlChooseExternalImpl">
...
```
          ...
          <DocBlock title="OCamlDataConversion" kind="lang" link="/docs/Stdlib/ocaml/external.mc/lang-OCamlDataConversion">
...
```
          ...
          <DocBlock title="OCamlDataConversionBase" kind="lang" link="/docs/Stdlib/ocaml/external.mc/lang-OCamlDataConversionBase">

```mc
lang OCamlDataConversionBase
```
...
```
          ...
          <DocBlock title="OCamlDataConversionOpaque" kind="lang" link="/docs/Stdlib/ocaml/external.mc/lang-OCamlDataConversionOpaque">

```mc
lang OCamlDataConversionOpaque
```
...
```
          ...
          <DocBlock title="OCamlDataConversionFun" kind="lang" link="/docs/Stdlib/ocaml/external.mc/lang-OCamlDataConversionFun">
...
```
          ...
          <DocBlock title="OCamlDataConversionString" kind="lang" link="/docs/Stdlib/ocaml/external.mc/lang-OCamlDataConversionString">
...
```
          ...
          <DocBlock title="OCamlDataConversionHelpers" kind="lang" link="/docs/Stdlib/ocaml/external.mc/lang-OCamlDataConversionHelpers">
...
```
          ...
          <DocBlock title="OCamlDataConversionList" kind="lang" link="/docs/Stdlib/ocaml/external.mc/lang-OCamlDataConversionList">

```mc
lang OCamlDataConversionList
```
...
```
          ...
          <DocBlock title="OCamlDataConversionArray" kind="lang" link="/docs/Stdlib/ocaml/external.mc/lang-OCamlDataConversionArray">

```mc
lang OCamlDataConversionArray
```
...
```
          ...
          <DocBlock title="OCamlDataConversionTuple" kind="lang" link="/docs/Stdlib/ocaml/external.mc/lang-OCamlDataConversionTuple">

```mc
lang OCamlDataConversionTuple
```
...
```
          ...
          <DocBlock title="OCamlDataConversionRecords" kind="lang" link="/docs/Stdlib/ocaml/external.mc/lang-OCamlDataConversionRecords">

```mc
lang OCamlDataConversionRecords
```
...
```
          ...
          <DocBlock title="OCamlDataConversionBigArray" kind="lang" link="/docs/Stdlib/ocaml/external.mc/lang-OCamlDataConversionBigArray">

```mc
lang OCamlDataConversionBigArray
```
...
```
          ...
          <DocBlock title="OCamlDataConversionMExpr" kind="lang" link="/docs/Stdlib/ocaml/external.mc/lang-OCamlDataConversionMExpr">

```mc
lang OCamlDataConversionMExpr
```
...
```
          ...
          <DocBlock title="OCamlGenerateExternalNaive" kind="lang" link="/docs/Stdlib/ocaml/external.mc/lang-OCamlGenerateExternalNaive">

```mc
lang OCamlGenerateExternalNaive
```

<Description>{`A naive implementation of external generation where we just pick the  
implementation with the lowest cost with respect to the type given at the  
external term definition.`}</Description>
...
## Variables  
          ...
          <DocBlock title="_approxsize" kind="let">
...
```
          ...
          <DocBlock title="_listToSeqCost" kind="let">

```mc
let _listToSeqCost  : Int
```
...
```
          ...
          <DocBlock title="_arrayToSeqCost" kind="let">

```mc
let _arrayToSeqCost  : Int
```
...
```
          ...
          <DocBlock title="_tensorToGenarrayCost" kind="let">

```mc
let _tensorToGenarrayCost  : Int
```
...
```
          ...
          <DocBlock title="_tupleConversionCost" kind="let">

```mc
let _tupleConversionCost  : Int
```
...
```
          ...
          <DocBlock title="_recordConversionCost" kind="let">

```mc
let _recordConversionCost  : Int
```
...
```
          ...
          <DocBlock title="_seqtostringcost" kind="let">

```mc
let _seqtostringcost  : Int
```
