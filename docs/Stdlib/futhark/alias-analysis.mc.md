...
<a href={"/docs/Stdlib/futhark/ast.mc"} style={S.link}>futhark/ast.mc</a>, <a href={"/docs/Stdlib/futhark/ast-builder.mc"} style={S.link}>futhark/ast-builder.mc</a>, <a href={"/docs/Stdlib/futhark/pprint.mc"} style={S.link}>futhark/pprint.mc</a>  
  
## Types  
  

          <DocBlock title="Alias" kind="type">
...
```
          ...
          <DocBlock title="ArrayID" kind="type">

```mc
type ArrayID : Name
```

<Description>{`We use names to represent a unique array value within the local function.`}</Description>
...
```
          ...
          <DocBlock title="AliasResult" kind="type">
...
```
          ...
          <DocBlock title="FutharkAliasAnalysisEnv" kind="type">

```mc
type FutharkAliasAnalysisEnv : { aliases: Map Name AliasResult, expired: Set Name, inPlaceUpdates: Set ArrayID }
```
...
## Constructors  
          ...
          <DocBlock title="AliasName" kind="con">
...
```
          ...
          <DocBlock title="AliasField" kind="con">
...
```
          ...
          <DocBlock title="EmptyAliasResult" kind="con">
...
```
          ...
          <DocBlock title="LeafAliasResult" kind="con">
...
```
          ...
          <DocBlock title="RecordAliasResult" kind="con">
...
## Languages  
          ...
          <DocBlock title="FutharkAliasAnalysis" kind="lang" link="/docs/Stdlib/futhark/alias-analysis.mc/lang-FutharkAliasAnalysis">

```mc
lang FutharkAliasAnalysis
```
...
## Variables  
          ...
          <DocBlock title="getAliasResultIdentifiers" kind="let">

```mc
let getAliasResultIdentifiers r : AliasResult -> Set Name
```
...
```
          ...
          <DocBlock title="aliasCmp" kind="let">

```mc
let aliasCmp l r : Alias -> Alias -> Int
```
...
<ToggleWrapper text="Code..">
```mc
let aliasCmp = lam l : Alias. lam r : Alias.
  let t = (l, r) in
