...
<a href={"/docs/Stdlib/string.mc"} style={S.link}>string.mc</a>, <a href={"/docs/Stdlib/futhark/ast.mc"} style={S.link}>futhark/ast.mc</a>, <a href={"/docs/Stdlib/futhark/ast-builder.mc"} style={S.link}>futhark/ast-builder.mc</a>, <a href={"/docs/Stdlib/futhark/pprint.mc"} style={S.link}>futhark/pprint.mc</a>  
  
## Languages  
  

          <DocBlock title="FutharkForEachRecordPattern" kind="lang" link="/docs/Stdlib/futhark/for-each-record-pat.mc/lang-FutharkForEachRecordPattern">

```mc
lang FutharkForEachRecordPattern
```
