...
<a href={"/docs/Stdlib/futhark/ast.mc"} style={S.link}>ast.mc</a>, <a href={"/docs/Stdlib/futhark/ast-builder.mc"} style={S.link}>ast-builder.mc</a>, <a href={"/docs/Stdlib/futhark/pprint.mc"} style={S.link}>pprint.mc</a>, <a href={"/docs/Stdlib/set.mc"} style={S.link}>set.mc</a>, <a href={"/docs/Stdlib/mexpr/ast.mc"} style={S.link}>mexpr/ast.mc</a>, <a href={"/docs/Stdlib/mexpr/ast-builder.mc"} style={S.link}>mexpr/ast-builder.mc</a>, <a href={"/docs/Stdlib/mexpr/cmp.mc"} style={S.link}>mexpr/cmp.mc</a>, <a href={"/docs/Stdlib/mexpr/pprint.mc"} style={S.link}>mexpr/pprint.mc</a>, <a href={"/docs/Stdlib/mexpr/symbolize.mc"} style={S.link}>mexpr/symbolize.mc</a>, <a href={"/docs/Stdlib/mexpr/type-check.mc"} style={S.link}>mexpr/type-check.mc</a>, <a href={"/docs/Stdlib/pmexpr/ast.mc"} style={S.link}>pmexpr/ast.mc</a>, <a href={"/docs/Stdlib/pmexpr/utils.mc"} style={S.link}>pmexpr/utils.mc</a>  
  
## Types  
  

          <DocBlock title="FutharkGenerateEnv" kind="type">

```mc
type FutharkGenerateEnv : { entryPoints: Set Name, boundNames: Map Name Expr }
```
...
## Languages  
          ...
          <DocBlock title="FutharkConstGenerate" kind="lang" link="/docs/Stdlib/futhark/generate.mc/lang-FutharkConstGenerate">

```mc
lang FutharkConstGenerate
```
...
```
          ...
          <DocBlock title="FutharkTypeGenerate" kind="lang" link="/docs/Stdlib/futhark/generate.mc/lang-FutharkTypeGenerate">

```mc
lang FutharkTypeGenerate
```
...
```
          ...
          <DocBlock title="FutharkPatternGenerate" kind="lang" link="/docs/Stdlib/futhark/generate.mc/lang-FutharkPatternGenerate">

```mc
lang FutharkPatternGenerate
```
...
```
          ...
          <DocBlock title="FutharkMatchGenerate" kind="lang" link="/docs/Stdlib/futhark/generate.mc/lang-FutharkMatchGenerate">

```mc
lang FutharkMatchGenerate
```
...
```
          ...
          <DocBlock title="FutharkAppGenerate" kind="lang" link="/docs/Stdlib/futhark/generate.mc/lang-FutharkAppGenerate">

```mc
lang FutharkAppGenerate
```
...
```
          ...
          <DocBlock title="FutharkExprGenerate" kind="lang" link="/docs/Stdlib/futhark/generate.mc/lang-FutharkExprGenerate">

```mc
lang FutharkExprGenerate
```
...
```
          ...
          <DocBlock title="FutharkToplevelGenerate" kind="lang" link="/docs/Stdlib/futhark/generate.mc/lang-FutharkToplevelGenerate">

```mc
lang FutharkToplevelGenerate
```
...
```
          ...
          <DocBlock title="FutharkGenerate" kind="lang" link="/docs/Stdlib/futhark/generate.mc/lang-FutharkGenerate">
...
```
          ...
          <DocBlock title="TestLang" kind="lang" link="/docs/Stdlib/futhark/generate.mc/lang-TestLang">
...
## Variables  
          ...
          <DocBlock title="extMap" kind="let">
