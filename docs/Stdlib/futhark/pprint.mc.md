...
<a href={"/docs/Stdlib/futhark/ast-builder.mc"} style={S.link}>ast-builder.mc</a>, <a href={"/docs/Stdlib/common.mc"} style={S.link}>common.mc</a>, <a href={"/docs/Stdlib/math.mc"} style={S.link}>math.mc</a>, <a href={"/docs/Stdlib/ocaml/pprint.mc"} style={S.link}>ocaml/pprint.mc</a>, <a href={"/docs/Stdlib/mexpr/record.mc"} style={S.link}>mexpr/record.mc</a>  
  
## Languages  
  

          <DocBlock title="FutharkLiteralSizePrettyPrint" kind="lang" link="/docs/Stdlib/futhark/pprint.mc/lang-FutharkLiteralSizePrettyPrint">

```mc
lang FutharkLiteralSizePrettyPrint
```
...
```
          ...
          <DocBlock title="FutharkConstPrettyPrint" kind="lang" link="/docs/Stdlib/futhark/pprint.mc/lang-FutharkConstPrettyPrint">

```mc
lang FutharkConstPrettyPrint
```
...
```
          ...
          <DocBlock title="FutharkPatPrettyPrint" kind="lang" link="/docs/Stdlib/futhark/pprint.mc/lang-FutharkPatPrettyPrint">

```mc
lang FutharkPatPrettyPrint
```
...
```
          ...
          <DocBlock title="FutharkTypeParamPrettyPrint" kind="lang" link="/docs/Stdlib/futhark/pprint.mc/lang-FutharkTypeParamPrettyPrint">

```mc
lang FutharkTypeParamPrettyPrint
```
...
```
          ...
          <DocBlock title="FutharkTypePrettyPrint" kind="lang" link="/docs/Stdlib/futhark/pprint.mc/lang-FutharkTypePrettyPrint">

```mc
lang FutharkTypePrettyPrint
```
...
```
          ...
          <DocBlock title="FutharkExprPrettyPrint" kind="lang" link="/docs/Stdlib/futhark/pprint.mc/lang-FutharkExprPrettyPrint">

```mc
lang FutharkExprPrettyPrint
```
...
```
          ...
          <DocBlock title="FutharkPrettyPrint" kind="lang" link="/docs/Stdlib/futhark/pprint.mc/lang-FutharkPrettyPrint">
...
## Variables  
          ...
          <DocBlock title="_futReplaceInvalidChar" kind="let">

```mc
let _futReplaceInvalidChar c : Char -> Char
```
...
```
          ...
          <DocBlock title="_futEscapeIdentifier" kind="let">

```mc
let _futEscapeIdentifier str : String -> String
```
...
```
          ...
          <DocBlock title="_futEscapeLabel" kind="let">

```mc
let _futEscapeLabel str : String -> String
```
...
```
          ...
          <DocBlock title="futPprintEnvGetStr" kind="let">

```mc
let futPprintEnvGetStr env id : PprintEnv -> Name -> (PprintEnv, String)
```
...
```
          ...
          <DocBlock title="futPprintLabelString" kind="let">

```mc
let futPprintLabelString env sid : PprintEnv -> SID -> (PprintEnv, String)
```
