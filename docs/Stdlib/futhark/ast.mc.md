...
<a href={"/docs/Stdlib/assoc-seq.mc"} style={S.link}>assoc-seq.mc</a>, <a href={"/docs/Stdlib/mexpr/ast.mc"} style={S.link}>mexpr/ast.mc</a>, <a href={"/docs/Stdlib/mexpr/info.mc"} style={S.link}>mexpr/info.mc</a>  
  
## Languages  
  

          <DocBlock title="FutharkLiteralSizeAst" kind="lang" link="/docs/Stdlib/futhark/ast.mc/lang-FutharkLiteralSizeAst">
...
```
          ...
          <DocBlock title="FutharkTypeParamAst" kind="lang" link="/docs/Stdlib/futhark/ast.mc/lang-FutharkTypeParamAst">
...
```
          ...
          <DocBlock title="FutharkConstAst" kind="lang" link="/docs/Stdlib/futhark/ast.mc/lang-FutharkConstAst">
...
```
          ...
          <DocBlock title="FutharkTypeAst" kind="lang" link="/docs/Stdlib/futhark/ast.mc/lang-FutharkTypeAst">
...
```
          ...
          <DocBlock title="FutharkPatAst" kind="lang" link="/docs/Stdlib/futhark/ast.mc/lang-FutharkPatAst">
...
```
          ...
          <DocBlock title="FutharkExprAst" kind="lang" link="/docs/Stdlib/futhark/ast.mc/lang-FutharkExprAst">
...
```
          ...
          <DocBlock title="FutharkAst" kind="lang" link="/docs/Stdlib/futhark/ast.mc/lang-FutharkAst">
