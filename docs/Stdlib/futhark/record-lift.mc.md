...
<a href={"/docs/Stdlib/stringid.mc"} style={S.link}>stringid.mc</a>, <a href={"/docs/Stdlib/futhark/ast.mc"} style={S.link}>futhark/ast.mc</a>, <a href={"/docs/Stdlib/futhark/ast-builder.mc"} style={S.link}>futhark/ast-builder.mc</a>, <a href={"/docs/Stdlib/futhark/pprint.mc"} style={S.link}>futhark/pprint.mc</a>  
  
## Languages  
  

          <DocBlock title="FutharkRecordParamLift" kind="lang" link="/docs/Stdlib/futhark/record-lift.mc/lang-FutharkRecordParamLift">

```mc
lang FutharkRecordParamLift
```
...
## Variables  
          ...
          <DocBlock title="_collectAppTargetAndArgs" kind="let">

```mc
let _collectAppTargetAndArgs e : FutharkExprAst_FutExpr -> (FutharkExprAst_FutExpr, [FutharkExprAst_FutExpr])
```
...
```
          ...
          <DocBlock title="_constructAppSeq" kind="let">

```mc
let _constructAppSeq target args : FutharkExprAst_FutExpr -> [FutharkExprAst_FutExpr] -> FutharkExprAst_FutExpr
```
