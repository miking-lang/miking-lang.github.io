...
<a href={"/docs/Stdlib/map.mc"} style={S.link}>map.mc</a>, <a href={"/docs/Stdlib/string.mc"} style={S.link}>string.mc</a>, <a href={"/docs/Stdlib/c/ast.mc"} style={S.link}>c/ast.mc</a>, <a href={"/docs/Stdlib/c/pprint.mc"} style={S.link}>c/pprint.mc</a>, <a href={"/docs/Stdlib/futhark/pprint.mc"} style={S.link}>futhark/pprint.mc</a>, <a href={"/docs/Stdlib/mexpr/ast.mc"} style={S.link}>mexpr/ast.mc</a>, <a href={"/docs/Stdlib/mexpr/ast-builder.mc"} style={S.link}>mexpr/ast-builder.mc</a>, <a href={"/docs/Stdlib/mexpr/pprint.mc"} style={S.link}>mexpr/pprint.mc</a>, <a href={"/docs/Stdlib/mexpr/record.mc"} style={S.link}>mexpr/record.mc</a>, <a href={"/docs/Stdlib/pmexpr/extract.mc"} style={S.link}>pmexpr/extract.mc</a>, <a href={"/docs/Stdlib/pmexpr/wrapper.mc"} style={S.link}>pmexpr/wrapper.mc</a>  
  
## Languages  
  

          <DocBlock title="FutharkCWrapperBase" kind="lang" link="/docs/Stdlib/futhark/wrapper.mc/lang-FutharkCWrapperBase">

```mc
lang FutharkCWrapperBase
```
...
```
          ...
          <DocBlock title="FutharkOCamlToCWrapper" kind="lang" link="/docs/Stdlib/futhark/wrapper.mc/lang-FutharkOCamlToCWrapper">

```mc
lang FutharkOCamlToCWrapper
```
...
```
          ...
          <DocBlock title="CToFutharkWrapper" kind="lang" link="/docs/Stdlib/futhark/wrapper.mc/lang-CToFutharkWrapper">

```mc
lang CToFutharkWrapper
```
...
```
          ...
          <DocBlock title="FutharkCallWrapper" kind="lang" link="/docs/Stdlib/futhark/wrapper.mc/lang-FutharkCallWrapper">

```mc
lang FutharkCallWrapper
```
...
```
          ...
          <DocBlock title="FutharkToCWrapper" kind="lang" link="/docs/Stdlib/futhark/wrapper.mc/lang-FutharkToCWrapper">

```mc
lang FutharkToCWrapper
```
...
```
          ...
          <DocBlock title="FutharkCToOCamlWrapper" kind="lang" link="/docs/Stdlib/futhark/wrapper.mc/lang-FutharkCToOCamlWrapper">

```mc
lang FutharkCToOCamlWrapper
```
...
```
          ...
          <DocBlock title="FutharkCWrapper" kind="lang" link="/docs/Stdlib/futhark/wrapper.mc/lang-FutharkCWrapper">
...
```
          ...
          <DocBlock title="Test" kind="lang" link="/docs/Stdlib/futhark/wrapper.mc/lang-Test">
...
## Variables  
          ...
          <DocBlock title="getFutharkSeqTypeString" kind="let">

```mc
let getFutharkSeqTypeString futharkElementTypeString numDims : String -> Int -> String
```
