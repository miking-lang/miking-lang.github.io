...
<a href={"/docs/Stdlib/map.mc"} style={S.link}>map.mc</a>, <a href={"/docs/Stdlib/name.mc"} style={S.link}>name.mc</a>, <a href={"/docs/Stdlib/union-find.mc"} style={S.link}>union-find.mc</a>, <a href={"/docs/Stdlib/futhark/ast.mc"} style={S.link}>futhark/ast.mc</a>, <a href={"/docs/Stdlib/futhark/pprint.mc"} style={S.link}>futhark/pprint.mc</a>  
  
## Languages  
  

          <DocBlock title="FutharkSizeType" kind="lang" link="/docs/Stdlib/futhark/size-parameterize.mc/lang-FutharkSizeType">

```mc
lang FutharkSizeType
```

<Description>{`A size parameter represents the size of one dimension of an array. As an  
...
```
          ...
          <DocBlock title="FutharkSizeTypeEliminate" kind="lang" link="/docs/Stdlib/futhark/size-parameterize.mc/lang-FutharkSizeTypeEliminate">

```mc
lang FutharkSizeTypeEliminate
```
...
```
          ...
          <DocBlock title="FutharkSizeParameterize" kind="lang" link="/docs/Stdlib/futhark/size-parameterize.mc/lang-FutharkSizeParameterize">

```mc
lang FutharkSizeParameterize
```
...
```
          ...
          <DocBlock title="TestLang" kind="lang" link="/docs/Stdlib/futhark/size-parameterize.mc/lang-TestLang">
