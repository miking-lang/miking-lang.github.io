...
<Tabs>
<TabItem value="optdep-default" label="Linux" default>
...
<TabItem value="optdep-macos-arm64" label="Mac (Apple M1)">

Before installing the Opam packages, we need to manually install openblas and
